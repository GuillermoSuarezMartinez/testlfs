...
namespace Orbita.Controles.VA
{
    ...
    /// </summary>
    public partial class OrbitaVisorBitmap : OrbitaVisorBase
    {
        #region Atributo(s)
        /// <summary>
        ...
        public OrbitaVisorBitmap(string titulo, string codCamara, double maxFrameIntervalVisualizacion, bool asociarCamara, bool visualizarEnVivo) :
