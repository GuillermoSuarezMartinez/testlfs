...
namespace Orbita.Controles.Comunes
{
    ...
    public partial class OrbitaTactilListButton : UserControl
    {
        ...
        /// <summary>
        /// Habilita los botones que coinciden con los códigos
        /// </summary>
        /// <param name="codigos"></param>
        public void Habilitar(params string[] codigos)
        {
            foreach (Control c in this.ListaBotones.Values)
            {
                bool existe = false;
        ...
        /// <summary>
        /// Deshabilita los botones que coinciden con los códigos
        /// </summary>
        /// <param name="codigos"></param>
        public void DesHabilitar(params string[] codigos)
        {
            foreach (Control c in this.ListaBotones.Values)
            {
                bool existe = false;
        ...
        /// <summary>
        /// Habilita los botones que coinciden con los códigos, el resto los deshabilita
        /// </summary>
        /// <param name="codigos"></param>
        public void HabilitarExcluyente(params string[] codigos)
        {
            foreach (OrbitaTactilButton c in this.ListaBotones.Values)
            {
                bool existe = false;
                foreach (string codigo in codigos)
                {
        ...
        /// <summary>
        /// Deshabilita los botones que coinciden con los códigos, el resto los habilita
        /// </summary>
        /// <param name="codigos"></param>
        public void DesHabilitarExcluyente(params string[] codigos)
        {
            foreach (OrbitaTactilButton c in this.ListaBotones.Values)
            {
                bool existe = false;
