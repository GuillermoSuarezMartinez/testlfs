...
{
    /// <summary>
    /// Control Orbita.Controles.GateSuite.OrbitaGSButon asociado a los eventos de comunicaciones
    /// </summary>
    public partial class OrbitaGSButon : OrbitaControlBaseEventosComs
    {
        /// <summary>
        /// Clase de las propiedades del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        public new class ControlNuevaDefinicion : OGSButon
        {
            public ControlNuevaDefinicion(OrbitaGSButon sender)
                : base(sender) { }
        };

        #region Atributos
        /// <summary>
        /// Definición de las propiedades del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        new ControlNuevaDefinicion definicion;
        /// <summary>
        /// Logger del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        ILogger Logger = LogManager.GetLogger("OrbitaGSButon");
        #endregion

        #region Delegados
        /// <summary>
        /// Delegado para el cambio de valor de la propiedad .Text del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        /// <param name="valor">valor de la propiedad .Text</param>
        internal delegate void DelegadoValor(string valor);
        /// <summary>
        /// Delegado para el cambio de color de la propiedad .BackColor del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        /// <param name="color">color de la propiedad .BackColor</param>
        internal delegate void DelegadoColor(Color color);
        /// <summary>
        /// Delegado para el cambio de dato del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoCambioDato(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la alarma del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoAlarma(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la comunicación del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        #region Propiedades
        /// <summary>
        /// Obtiene o establece las propiedades del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        ...
        #region Constructor
        /// <summary>
        /// Inicializa una nueva instancia del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        public OrbitaGSButon()
        {
            InitializeComponent();
        ...
        #region Eventos
        /// <summary>
        /// Cambia la propiedad .BackColor y lanza el evento OnAlarma del control Orbita.Controles.GateSuite.OrbitaGSButon al lanzarse una alarma asociada a Alarmas      
        /// </summary>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnAlarma != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarAlarma en Orbita.Controles.GateSuite.OrbitaGSButon");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Cambia la propiedad .BackColor y lanza el evento de comunicación del control Orbita.Controles.GateSuite.OrbitaGSButon dependiendo de si se comunica o no con el Servidor de Comunicaciones      
        /// </summary>
        /// <param name="e"></param>
        public override void ProcesarComunicaciones(Orbita.Utiles.OEventArgs e)
        {
            try
            {
                ...
                if (this.OnComunicacion != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarComunicacion en Orbita.Controles.GateSuite.OrbitaGSButon");
                        }
                    }
                }
            }
            ...
            {
                Logger.Error(ex, "ProcesarComunicaciones en Orbita.Controles.GateSuite.OrbitaGSButon");
            }

        }
        /// <summary>
        /// Lanza el evento OnCambio del control Orbita.Controles.GateSuite.OrbitaGSButon con el cambio de dato de una de las variables asociadas al Cambio.        
        /// </summary>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnCambioDato != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarCambioDato en Orbita.Controles.GateSuite.OrbitaGSButon");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Cambia la propiedad .Text del control Orbita.Controles.GateSuite.OrbitaGSButon con el cambio de dato de la variable asociada a Variable.        
        /// </summary>
        /// <param name="e"></param>    
        public override void ProcesarVariableVisual(Orbita.Utiles.OEventArgs e)
        {
            ...
            {
                Logger.Error(ex, "ProcesarVariableVisual en Orbita.Controles.GateSuite.OrbitaGSButon");
            }
        }
        #endregion
        ...
        /// <summary>
        /// Inicializa los atributos de las propiedades del control Orbita.Controles.GateSuite.OrbitaGSButon
        /// </summary>
        ...
        /// <summary>
        /// Cambia la propiedad .BackColor del control Orbita.Controles.GateSuite.OrbitaGSButon ante una Alarma      
        /// </summary>
        /// <param name="color">color</param>
        private void CambiarFondoAlarma(Color color)
        {
            if (this.bEventosComs.InvokeRequired)
            {
            ...
            {
                this.bEventosComs.Appearance.BackColor = color;
            }
        }
        /// <summary>
        /// Cambia la propiedad .BackColor del control Orbita.Controles.GateSuite.OrbitaGSButon ante un cambio de la comunicación con el Servidor de Comunicaciones       
        /// </summary>
        /// <param name="color">color</param>
        ...
        /// <summary>
        /// Cambia el valor de la propiedad .Text del control Orbita.Controles.GateSuite.OrbitaGSButon ante el cambio de dato de la Variable
        /// </summary>
