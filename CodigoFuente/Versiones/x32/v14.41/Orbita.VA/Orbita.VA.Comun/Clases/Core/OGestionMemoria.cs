...
namespace Orbita.VA.Comun
{
    ...
    public static class OGestionMemoriaManager
    {
        ...
        /// </summary>
        private static string COD_CRONOMETRO_COLECTOR_BASURA_EJECUCION
        {
            get
            {
                return OSistemaManager.COD_CRONOMETRO_PREFIJO + ".GarbageCollector.Ejecucion";
            }
        }
        /// <summary>
        /// Prefijo del código del cronómetro asociado
        /// </summary>
        private static string COD_CRONOMETRO_COLECTOR_BASURA_CADENCIA
        {
            get
            {
                return OSistemaManager.COD_CRONOMETRO_PREFIJO + ".GarbageCollector.Cadencia";
            }
        }
        #endregion
        ...
        public static void Inicializar()
        {
            ...
            OCronometrosManager.NuevoCronometro(COD_CRONOMETRO_COLECTOR_BASURA_EJECUCION, "EjecucionLiberadorMemoria", "Tiempo de ejecución de la liberación de memoria");
            OCronometrosManager.NuevoCronometro(COD_CRONOMETRO_COLECTOR_BASURA_CADENCIA, "CadenciaLiberadorMemoria", "Intervalo de tiempo entre liberaciones de memoria");
        }
        ...
        {
            OCronometrosManager.Stop(COD_CRONOMETRO_COLECTOR_BASURA_CADENCIA);
            OCronometrosManager.Start(COD_CRONOMETRO_COLECTOR_BASURA_CADENCIA);

            OCronometrosManager.Start(COD_CRONOMETRO_COLECTOR_BASURA_EJECUCION);
            ...
            OCronometrosManager.Stop(COD_CRONOMETRO_COLECTOR_BASURA_EJECUCION);
        }
	    #endregion    
    }
