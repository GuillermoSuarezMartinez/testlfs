...
#if VARIABLES_REMOTAS
                    this.VariableCore = new VariableCore(this._Codigo, habilitado, this.CompartirRemotamente, tipo, guardarTrazabilidad);
#else
                    this.VariableCore = new VariableCore(this._Codigo, habilitado, tipo, guardarTrazabilidad);
#endif
