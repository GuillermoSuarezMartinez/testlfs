...
namespace Orbita.VA.Funciones
{
    ...
    public static class OFuncionesVisionManager
    {
        ...
        /// </summary>
        internal const string COD_CRONOMETRO_PREFIJO = "FuncionesVision";
        #endregion
    ...
    public class OFuncionVisionBase
    {
        ...
        protected string COD_CRONOMETRO
        {
            get
            {
                return OFuncionesVisionManager.COD_CRONOMETRO_PREFIJO + "." + this._Codigo;
            }
        }
        #endregion
        ...
        public OFuncionVisionBase(string codFuncionVision)
        {
            ...
            if (dtFuncionVision.Rows.Count == 1)
            {
                ...
                this.Cronometro = OCronometrosManager.NuevoCronometro(this.COD_CRONOMETRO, "Ejecución función " + this.Nombre, "Ejecución de la función de visión " + this.Nombre);
            }
        }
        ...
        protected void FuncionEjecutada()
        {
            try
            {
                ...
                // Guardamos la traza
                OLogsVAFunciones.Vision.Info(this._Codigo, "Fin de la ejecución de la función " + this._Codigo + ". Duración: " + OCronometrosManager.DuracionUltimaEjecucion(this.COD_CRONOMETRO).ToString());
