...
namespace Orbita.Utiles
{
    ...
    public class OEntero : OObjetoBase<int>
    {
        ...
        public override EnumEstadoRobusto Validar(ref object valor)
        {
            ...
            // Validación nº 0 // Solución problema conversión tipo long
            if (!correcto)
            {
                if (valor is long)
                {
                    long v = Convert.ToInt64(valor);
                    if (v < int.MinValue)
                    {
                        v = int.MinValue;
                    }
                    ...
                    auxValor = Convert.ToInt32(v);
                    validacion = EnumEstadoEnteroRobusto.ResultadoCorrecto;
                    correcto = true;
                }
                if (valor is ulong)
                {
                    ulong v = Convert.ToUInt64(valor);
                    if (v > int.MaxValue)
                    {
                        v = int.MaxValue;
                    }
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(uint valor, uint min, uint max)
        {
            return (valor >= min) && (valor <= max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(short valor, short min, short max)
        {
            return (valor >= min) && (valor <= max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(ushort valor, ushort min, ushort max)
        {
            return (valor >= min) && (valor <= max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(byte valor, byte min, byte max)
        {
            return (valor >= min) && (valor <= max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static uint AsegurarRango(uint valor, uint min, uint max)
        {
            uint resultado = valor;
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static short AsegurarRango(short valor, short min, short max)
        {
            short resultado = valor;
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static ushort AsegurarRango(ushort valor, ushort min, ushort max)
        {
            ushort resultado = valor;
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static byte AsegurarRango(byte valor, byte min, byte max)
        {
            byte resultado = valor;
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(uint valor, uint media, uint tolerancia)
        {
            return (valor >= media - tolerancia) && (valor <= media + tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(short valor, short media, short tolerancia)
        {
            return (valor >= media - tolerancia) && (valor <= media + tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(ushort valor, ushort media, ushort tolerancia)
        {
            return (valor >= media - tolerancia) && (valor <= media + tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(byte valor, byte media, byte tolerancia)
        {
            return (valor >= media - tolerancia) && (valor <= media + tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static uint AsegurarTolerancia(uint valor, uint media, uint tolerancia)
        {
            uint resultado = valor;
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static short AsegurarTolerancia(short valor, short media, short tolerancia)
        {
            short resultado = valor;

            if (valor < media - tolerancia)
            {
                resultado = (short)(media - tolerancia);
            }
            if (valor > media + tolerancia)
            {
                resultado = (short)(media + tolerancia);
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static ushort AsegurarTolerancia(ushort valor, ushort media, ushort tolerancia)
        {
            ushort resultado = valor;

            if (valor < media - tolerancia)
            {
                resultado = (ushort)(media - tolerancia);
            }
            if (valor > media + tolerancia)
            {
                resultado = (ushort)(media + tolerancia);
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static byte AsegurarTolerancia(byte valor, byte media, byte tolerancia)
        {
            byte resultado = valor;

            if (valor < media - tolerancia)
            {
                resultado = (byte)(media - tolerancia);
            }
            if (valor > media + tolerancia)
            {
                resultado = (byte)(media + tolerancia);
    ...
    public static class OEnteroExtension
    {
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(this uint valor, uint min, uint max)
        {
            return OEntero.EnRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(this short valor, short min, short max)
        {
            return OEntero.EnRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(this ushort valor, ushort min, ushort max)
        {
            return OEntero.EnRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(this byte valor, byte min, byte max)
        {
            return OEntero.EnRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static uint AsegurarRango(this uint valor, uint min, uint max)
        {
            return OEntero.AsegurarRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static short AsegurarRango(this short valor, short min, short max)
        {
            return OEntero.AsegurarRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static ushort AsegurarRango(this ushort valor, ushort min, ushort max)
        {
            return OEntero.AsegurarRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static byte AsegurarRango(this byte valor, byte min, byte max)
        {
            return OEntero.AsegurarRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(this uint valor, uint media, uint tolerancia)
        {
            return OEntero.EnTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(this short valor, short media, short tolerancia)
        {
            return OEntero.EnTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(this ushort valor, ushort media, ushort tolerancia)
        {
            return OEntero.EnTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(this byte valor, byte media, byte tolerancia)
        {
            return OEntero.EnTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static uint AsegurarTolerancia(this uint valor, uint media, uint tolerancia)
        {
            return OEntero.AsegurarTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static short AsegurarTolerancia(this short valor, short media, short tolerancia)
        {
            return OEntero.AsegurarTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static ushort AsegurarTolerancia(this ushort valor, ushort media, ushort tolerancia)
        {
            return OEntero.AsegurarTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static byte AsegurarTolerancia(this byte valor, byte media, byte tolerancia)
        {
            return OEntero.AsegurarTolerancia(valor, media, tolerancia);
        }
        #endregion
    ...
    #region Entero Largo Robusto
    /// <summary>
    /// Asignación de una variable a un campo de tipo entero
    /// </summary>
    public class OEnteroLargo : OObjetoBase<long>
    {
        #region Atributos
        /// <summary>
        /// Valor mínimo
        /// </summary>
        public long MinValor;
        /// <summary>
        /// Valor máximo
        /// </summary>
        public long MaxValor;
        /// <summary>
        /// Formato cultural de los números en coma flotante
        /// </summary>
        public IFormatProvider Formato;
        ...
        /// Constructor de la clase
        /// </summary>
        public OEnteroLargo(string codigo, long minValor, long maxValor, long valorDefecto, bool lanzarExcepcionSiValorNoValido)
            : this(codigo, minValor, maxValor, CultureInfo.CurrentCulture, valorDefecto, lanzarExcepcionSiValorNoValido)
        {
        }
        /// <summary>
        /// Constructor de la clase
        /// </summary>
        public OEnteroLargo(string codigo, long minValor, long maxValor, IFormatProvider cultureInfo, long valorDefecto, bool lanzarExcepcionSiValorNoValido)
            : base(codigo, valorDefecto, lanzarExcepcionSiValorNoValido)
        {
            this.MinValor = minValor;
            this.MaxValor = maxValor;
        ...
        public override EnumEstadoRobusto Validar(ref object valor)
        {
            ...
            EnumEstadoRobusto validacion = EnumEstadoEnteroRobusto.ValorTipoIncorrecto;
            bool correcto = false;
            long outValor = this.ValorPorDefecto;
            long auxValor = this.ValorPorDefecto;
            ...
            if (!correcto)
            {
                if (EsEnteroLargo(valor))
                {
                    auxValor = Convert.ToInt64(valor);
                    validacion = EnumEstadoEnteroRobusto.ResultadoCorrecto;
                    correcto = true;
                }
            }
            ...
            if (!correcto)
            {
                ...
                {
                    long longValor;
                    if (long.TryParse((string)valor, NumberStyles.Any, this.Formato, out longValor))
                    {
                        auxValor = longValor;
                        validacion = EnumEstadoEnteroRobusto.ResultadoCorrecto;
                        correcto = true;
        ...
        {
            if (this.Estado == EnumEstadoEnteroRobusto.ValorTipoIncorrecto)
                throw new Exception("El campo " + this.Codigo + " no es un número entero largo.");
            if (this.Estado == EnumEstadoEnteroRobusto.ValorInferiorMinimo)
                throw new Exception("El campo " + this.Codigo + " es inferior al mínimo " + this.MinValor.ToString() + ".");
            if (this.Estado == EnumEstadoEnteroRobusto.ValorSuperiorMaximo)
                throw new Exception("El campo " + this.Codigo + " es superior al máximo " + this.MaxValor.ToString() + ".");
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long Validar(object valor, out EnumEstadoRobusto validacion, long min, long max, long defecto)
        {
            OEnteroLargo robusto = new OEnteroLargo(string.Empty, min, max, defecto, false);
            robusto.ValorGenerico = valor;
            validacion = robusto.Estado;
            return robusto.Valor;
        }
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long Validar(object valor, out EnumEstadoRobusto validacion, long min, long max, IFormatProvider cultureInfo, long defecto)
        {
            OEnteroLargo robusto = new OEnteroLargo(string.Empty, min, max, cultureInfo, defecto, false);
            robusto.ValorGenerico = valor;
            validacion = robusto.Estado;
            return robusto.Valor;
        }
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long Validar(object valor, long min, long max, long defecto)
        {
            OEnteroLargo robusto = new OEnteroLargo(string.Empty, min, max, defecto, false);
            robusto.ValorGenerico = valor;
            return robusto.Valor;
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long Validar(object valor, long min, long max, IFormatProvider cultureInfo, long defecto)
        {
            OEnteroLargo robusto = new OEnteroLargo(string.Empty, min, max, cultureInfo, defecto, false);
            robusto.ValorGenerico = valor;
            return robusto.Valor;
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long Validar(object valor)
        {
            return Validar(valor, long.MinValue, long.MaxValue, default(long));
        }
        /// <summary>
        /// Comprueba que el valor del objeto es correcto
        /// </summary>
        /// <param name="value">Valor del objeto a comprobar</param>
        /// <returns>Verdadero si el valor es correcto</returns>
        public static EnumEstadoRobusto Validar(object valor, string codigo, long min, long max, long defecto, bool lanzarExcepcionSiValorNoValido)
        {
            OEnteroLargo robusto = new OEnteroLargo(codigo, min, max, defecto, lanzarExcepcionSiValorNoValido);
            robusto.ValorGenerico = valor;
            valor = robusto.Valor;
            return robusto.Estado;
        }
        ...
        /// <param name="value">Valor del objeto a comprobar</param>
        /// <returns>Verdadero si el valor es correcto</returns>
        public static EnumEstadoRobusto Validar(object valor, string codigo, long min, long max, IFormatProvider cultureInfo, long defecto, bool lanzarExcepcionSiValorNoValido)
        {
            OEnteroLargo robusto = new OEnteroLargo(codigo, min, max, cultureInfo, defecto, lanzarExcepcionSiValorNoValido);
            robusto.ValorGenerico = valor;
            valor = robusto.Valor;
            return robusto.Estado;
        }
        ...
        /// <param name="o">Objeto que se quiere conocer si es de tipo entero</param>
        /// <returns>Verdadero si el tipo del objeto es entero</returns>
        public static bool EsEnteroLargo(object o)
        {
            return (o != null) && OObjeto.IsTypeOf(o, typeof(long), typeof(ulong));
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(long valor, long min, long max)
        {
            return (valor >= min) && (valor <= max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(ulong valor, ulong min, ulong max)
        {
            return (valor >= min) && (valor <= max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static long AsegurarRango(long valor, long min, long max)
        {
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static ulong AsegurarRango(ulong valor, ulong min, ulong max)
        {
            ulong resultado = valor;
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(long valor, long media, long tolerancia)
        {
            return (valor >= media - tolerancia) && (valor <= media + tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(ulong valor, ulong media, ulong tolerancia)
        {
            return (valor >= media - tolerancia) && (valor <= media + tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static long AsegurarTolerancia(long valor, long media, long tolerancia)
        {
            long resultado = valor;
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static ulong AsegurarTolerancia(ulong valor, ulong media, ulong tolerancia)
        {
            ulong resultado = valor;
    ...
    /// Asignación de una variable a un campo de tipo entero
    /// </summary>
    public static class OEnteroLargoExtension
    {
        #region Método(s) de extensión
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long ValidarEnteroLargo(this object valor, out EnumEstadoRobusto validacion, long min, long max, long defecto)
        {
            return OEnteroLargo.Validar(valor, out validacion, min, max, defecto);
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long ValidarEnteroLargo(this object valor, out EnumEstadoRobusto validacion, long min, long max, IFormatProvider cultureInfo, long defecto)
        {
            return OEnteroLargo.Validar(valor, out validacion, min, max, cultureInfo, defecto);
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long ValidarEnteroLargo(this object valor, long min, long max, long defecto)
        {
            return OEnteroLargo.Validar(valor, min, max, defecto);
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long ValidarEnteroLargo(this object valor, long min, long max, IFormatProvider cultureInfo, long defecto)
        {
            return OEnteroLargo.Validar(valor, min, max, cultureInfo, defecto);
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static long ValidarEnteroLargo(this object valor)
        {
            return OEnteroLargo.Validar(valor);
        }
        /// <summary>
        /// Comprueba que el valor del objeto es correcto
        /// </summary>
        /// <param name="value">Valor del objeto a comprobar</param>
        /// <returns>Verdadero si el valor es correcto</returns>
        public static EnumEstadoRobusto ValidarEnteroLargo(this object valor, string codigo, long min, long max, long defecto, bool lanzarExcepcionSiValorNoValido)
        {
            return OEnteroLargo.Validar(valor, codigo, min, max, defecto, lanzarExcepcionSiValorNoValido);
        }
        /// <summary>
        /// Comprueba que el valor del objeto es correcto
        /// </summary>
        /// <param name="value">Valor del objeto a comprobar</param>
        /// <returns>Verdadero si el valor es correcto</returns>
        public static EnumEstadoRobusto ValidarEnteroLargo(this object valor, string codigo, long min, long max, IFormatProvider cultureInfo, long defecto, bool lanzarExcepcionSiValorNoValido)
        {
            return OEnteroLargo.Validar(valor, codigo, min, max, cultureInfo, defecto, lanzarExcepcionSiValorNoValido);
        }
        /// <summary>
        /// Indica si el objeto pasado es de tipo entero
        /// </summary>
        /// <param name="o">Objeto que se quiere conocer si es de tipo entero</param>
        /// <returns>Verdadero si el tipo del objeto es entero</returns>
        public static bool EsEnteroLargo(this object o)
        {
            return OEnteroLargo.EsEnteroLargo(o);
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(this long valor, long min, long max)
        {
            return OEnteroLargo.EnRango(valor, min, max);
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnRango(this ulong valor, ulong min, ulong max)
        {
            return OEnteroLargo.EnRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static long AsegurarRango(this long valor, long min, long max)
        {
            return OEnteroLargo.AsegurarRango(valor, min, max);
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado y en caso contrario lo modifica para que cumpla la condición
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static ulong AsegurarRango(this ulong valor, ulong min, ulong max)
        {
            return OEnteroLargo.AsegurarRango(valor, min, max);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(this long valor, long media, long tolerancia)
        {
            return OEnteroLargo.EnTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado
        /// </summary>
        /// <returns>Devuelve verdadero si el parámetro está dentro del rango determinado</returns>
        public static bool EnTolerancia(this ulong valor, ulong media, ulong tolerancia)
        {
            return OEnteroLargo.EnTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static long AsegurarTolerancia(this long valor, long media, long tolerancia)
        {
            return OEnteroLargo.AsegurarTolerancia(valor, media, tolerancia);
        }
        /// <summary>
        /// Evalúa si el parámetro está dentro del rango determinado y en caso contrario lo modifica para que cumpla la condición
        /// </summary>
        /// <returns>Devuelve el número obligando a que esté dentro del rango determinado</returns>
        public static ulong AsegurarTolerancia(this ulong valor, ulong media, ulong tolerancia)
        {
            return OEnteroLargo.AsegurarTolerancia(valor, media, tolerancia);
        }
        #endregion
    ...
    public static class OBinario
    {
        ...
        /// <param name="posicion">Posición del bit a extraer</param>
        /// <returns>Booleano con el valor del bit extraido</returns>
        public static bool GetBit(this ulong numero, int posicion)
        {
            ulong mascara = Convert.ToUInt64(Math.Pow(2, posicion));
            return (numero & mascara) != 0;
        }
        /// <summary>
        ...
        /// <param name="posicion">Posición del bit a establecer</param>
        /// <param name="valor">Booleano con el valor del bit a establecer</param>
        public static void SetBit(ref ulong numero, int posicion, bool valor)
        {
            ulong mascara = Convert.ToUInt64(Math.Pow(2, posicion));
            if (valor)
            {
        ...
        /// <param name="posicion">Posición del bit a establecer</param>
        /// <param name="valor">Booleano con el valor del bit a establecer</param>
        public static ulong SetBit(this ulong numero, int posicion, bool valor)
        {
            ulong resultado = numero;
            SetBit(ref resultado, posicion, valor);
            return resultado;
        }
    }
