...
namespace Orbita.VA.Comun
{
    ...
    public static class AppBD
    {
        ...
        /// <summary>
        /// Obtiene los parámetros relacionados con los resultados de las funciones de visión
        /// </summary>
        /// <returns></returns>
        public static DataTable GetResultadosInspeccionesFuncionesVision()
        {
            ArrayList list = new ArrayList();

            return OBaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("VA_VIS_GET_VA_RESULTADOS_INSPECCIONES_FUNCIONES_VISION", list);
        }
        #endregion
