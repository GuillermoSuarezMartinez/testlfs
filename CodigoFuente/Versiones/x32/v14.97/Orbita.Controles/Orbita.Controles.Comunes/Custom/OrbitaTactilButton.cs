...
namespace Orbita.Controles.Comunes
{
    ...
    public partial class OrbitaTactilButton : UserControl
    {
        ...
        public bool Enabled
        {
            ...
            set 
            {
                short alphaEnabled = 0;
                short alphaDisabled = 100;

                lblTitulo.Appearance.AlphaLevel = value ? alphaEnabled : alphaDisabled;
                lblTitulo.Appearance.ImageBackgroundAlpha = Infragistics.Win.Alpha.UseAlphaLevel;
                lblDescripcion.Appearance.AlphaLevel = value ? alphaEnabled : alphaDisabled;
                lblDescripcion.Appearance.ImageBackgroundAlpha = Infragistics.Win.Alpha.UseAlphaLevel;
                lblIcono.Appearance.AlphaLevel = value ? alphaEnabled : alphaDisabled;
                lblIcono.Appearance.ImageBackgroundAlpha = Infragistics.Win.Alpha.UseAlphaLevel;
