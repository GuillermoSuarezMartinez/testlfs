...
namespace Orbita.VA.Hardware
{
    ...
    public class OCamaraBaslerPylon : OCamaraBitmap
    {
        ...
        /// Constructor de la clase
        /// </summary>
        public OCamaraBaslerPylon(string codigo, string deviceID)
            : base(codigo)
        {
            try
            {
    ...
    public class OPylonGigEFeatures
    {
        ...
        public OPylonGigEFeatures(string codigo, int timeOutAccesoGigEFeatures)
        {
            ...
            try
            {
                ...
                this.BalanceRatioRed = new OPylonWhiteBalance("WhiteBalanceRed", 0, 1023, 50, "Red", this.BalanceRatioRaw, this.BalanceRatioSelector, "Basler_Pilot_WhiteBalanceRed");
                this.BalanceRatioGreen = new OPylonWhiteBalance("BalanceRatioGreen", 0, 1023, 50, "Green", this.BalanceRatioRaw, this.BalanceRatioSelector, "Basler_Pilot_WhiteBalanceGreen");
                this.BalanceRatioBlue = new OPylonWhiteBalance("BalanceRatioBlue", 0, 1023, 50, "Blue", this.BalanceRatioRaw, this.BalanceRatioSelector, "Basler_Pilot_WhiteBalanceBlue");
                ...
                this.LineStatusAll = new OPylonGigEIntFeature("LineStatusAll", 0, long.MaxValue, 0, timeOutAccesoGigEFeatures, false, string.Empty, true);
    ...
    /// </summary>
    public class OPylonGigEIntFeature : OEnteroLargo, IPylonCamFeature
    {
        #region Atributo(s)
        /// <summary>
        /// Clase cognex para el acceso a los parámetros de la cámara
        ...
        /// Constructor de la clase
        /// </summary>
        public OPylonGigEIntFeature(string codigo, long minValue, long maxValue, long defaultValue, int timeOutMilis, bool accesoDirecto, string nombreColumna, bool obtencionRestriccionAutomatica)
        ...
        public void ObtenerRestricciones()
        {
            ...
            if (this.ValidForRead)
            {
                this.MinValor = Pylon.DeviceGetIntegerFeatureMin(this.PylonDeviceHandle, this.Codigo);
                this.MaxValor = Pylon.DeviceGetIntegerFeatureMax(this.PylonDeviceHandle, this.Codigo);
            }
        }
        /// <summary>
        ...
        public bool Receive()
        {
            ...
            try
            {
                if (this.PylonDeviceHandle != null)
                {
                    if (this.ValidForRead)
                    {
                        this.Valor = Pylon.DeviceGetIntegerFeature(this.PylonDeviceHandle, this.Codigo);
                        resultado = true;
                    }
                }
            }
    ...
    public class OPylonGigEDoubleFeature : ODecimal, IPylonCamFeature
    {
        ...
        public void ObtenerRestricciones()
        {
            ...
            if (this.ValidForRead)
            {
                this.MinValor = (int)Pylon.DeviceGetFloatFeatureMin(this.PylonDeviceHandle, this.Codigo);
                this.MaxValor = (int)Pylon.DeviceGetFloatFeatureMax(this.PylonDeviceHandle, this.Codigo);
            }
        }
        /// <summary>
        /// Aplica el valor de memoria a la cámara
    ...
    public class OPylonAOI : OObjetoBase<Rectangle>, IPylonCamFeature
    {
        ...
        public bool Send(bool force, ModoAjuste modoAjuste)
        {
            ...
            try
            {
                if ((modoAjuste == ModoAjuste.Inicializacion) || (modoAjuste == ModoAjuste.Ejecucion))
                {
                    this.Valor = new Rectangle(this.FeatureOffsetX.ValorGenerico.ValidarEntero(), this.FeatureOffsetY.ValorGenerico.ValidarEntero(), this.FeatureWidth.ValorGenerico.ValidarEntero(), this.FeatureHeight.ValorGenerico.ValidarEntero());
        ...
        public bool Send(bool force, ModoAjuste modoAjuste)
        {
            ...
            try
            {
                if ((modoAjuste == ModoAjuste.Inicializacion) || (modoAjuste == ModoAjuste.Ejecucion))
                {
                    ...
                    int packetSize = this.FeaturePacketSize.ValorGenerico.ValidarEntero(); // Valor cargado de BBDD
                    ...
                    int timeStampFreq = this.FeatureTimeStampFrequency.ValorGenerico.ValidarEntero();
        ...
        public override void LeerEntrada()
        {
            try
            {
                if (this.Conectividad.EstadoConexion == EstadoConexion.Conectado)
                {
                    ...
                    {
                        // Lectura de la entrada fisica
                        this.FeatureLineStatusAll.Receive();
                        long intValor = this.FeatureLineStatusAll.Valor;
                        ulong uIntValor = intValor < 0 ? 0 : (ulong)intValor;
                        bool boolValor = OBinario.GetBit(uIntValor, this.Numero);
