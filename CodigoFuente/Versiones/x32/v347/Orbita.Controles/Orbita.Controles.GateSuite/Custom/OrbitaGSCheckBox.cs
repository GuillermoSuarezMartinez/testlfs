...
{
    /// <summary>
    /// Control Orbita.Controles.GateSuite.OrbitaGSCheckBox asociado a los eventos de comunicaciones
    /// </summary>
    public partial class OrbitaGSCheckBox : OrbitaControlBaseEventosComs
    {
        /// <summary>
        /// Clase de las propiedades del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        public new class ControlNuevaDefinicion : OGSCheckBox
        {
            public ControlNuevaDefinicion(OrbitaGSCheckBox sender)
                : base(sender) { }
        };

        #region Atributos
        /// <summary>
        /// Definición de las propiedades del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        new ControlNuevaDefinicion definicion;
        /// <summary>
        /// Logger del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        ILogger Logger = LogManager.GetLogger("OrbitaGSCheckBox");
        #endregion

        #region Delegados
        /// <summary>
        /// Delegado para el cambio de valor de la propiedad .Text del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        /// <param name="valor">valor de la propiedad .Text</param>
        internal delegate void DelegadoValor(string valor);
        /// <summary>
        /// Delegado para el cambio de color de la propiedad .BackColor del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        /// <param name="color">color de la propiedad .BackColor</param>
        internal delegate void DelegadoColor(Color color);
        /// <summary>
        /// Delegado para el cambio de dato del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoCambioDato(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la alarma del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoAlarma(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la comunicación del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        #region Propiedades
        /// <summary>
        /// Obtiene o establece las propiedades del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        ...
        #region Constructor
        /// <summary>
        /// Inicializa una nueva instancia del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        public OrbitaGSCheckBox()
        {
            InitializeComponent();
        ...
        #region Eventos
        /// <summary>
        /// Cambia la propiedad .BackColor y lanza el evento OnAlarma del control Orbita.Controles.GateSuite.OrbitaGSCheckBox al lanzarse una alarma asociada a Alarmas      
        /// </summary>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnAlarma != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarAlarma en Orbita.Controles.GateSuite.OrbitaGSCheckBox");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Cambia la propiedad .BackColor y lanza el evento de comunicación del control Orbita.Controles.GateSuite.OrbitaGSCheckBox dependiendo de si se comunica o no con el Servidor de Comunicaciones      
        /// </summary>
        /// <param name="e"></param>
        public override void ProcesarComunicaciones(Orbita.Utiles.OEventArgs e)
        {
            try
            {
                ...
                if (this.OnComunicacion != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarComunicacion en Orbita.Controles.GateSuite.OrbitaGSCheckBox");
                        }
                    }
                }
            }
            ...
            {
                Logger.Error(ex, "ProcesarComunicaciones en Orbita.Controles.GateSuite.OrbitaGSCheckBox");
            }

        }
        /// <summary>
        /// Lanza el evanto OnCambio del control Orbita.Controles.GateSuite.OrbitaGSCheckBox con el cambio de dato de una de las variables asociadas al Cambio.        
        /// </summary>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnCambioDato != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarCambioDato en Orbita.Controles.GateSuite.OrbitaGSCheckBox");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Cambia la propiedad .Text del control Orbita.Controles.GateSuite.OrbitaGSCheckBox con el cambio de dato de la variable asociada a Variable.        
        /// </summary>
        /// <param name="e"></param>        
        public override void ProcesarVariableVisual(Orbita.Utiles.OEventArgs e)
        {
            ...
            {
                Logger.Error(ex, "ProcesarVariableVisual en Orbita.Controles.GateSuite.OrbitaGSCheckBox");
            }
        }
        #endregion
        ...
        /// <summary>
        /// Inicializa los atributos de las propiedades del control Orbita.Controles.GateSuite.OrbitaGSCheckBox
        /// </summary>
        ...
        /// <summary>
        /// Cambia la propiedad .BackColor del control Orbita.Controles.GateSuite.OrbitaGSCheckBox ante una Alarma      
        /// </summary>
        /// <param name="color">color</param>
        private void CambiarFondoAlarma(Color color)
        {
            if (this.chkEventosComs.InvokeRequired)
            {
            ...
            {
                this.chkEventosComs.Appearance.BackColor = color;
            }
        }
        /// <summary>
        /// Cambia la propiedad .BackColor del control Orbita.Controles.GateSuite.OrbitaGSCheckBox ante un cambio de la comunicación con el Servidor de Comunicaciones       
        /// </summary>
        /// <param name="color">color</param>
        ...
        /// <summary>
        /// Cambia el valor de la propiedad .Text del control Orbita.Controles.GateSuite.OrbitaGSCheckBox ante el cambio de dato de la Variable
        /// </summary>
        ...
        public void CambiarValor(string valor)
        {
            ...
            {
                this.chkEventosComs.Text = valor;
            }
        }
        #endregion
    }
