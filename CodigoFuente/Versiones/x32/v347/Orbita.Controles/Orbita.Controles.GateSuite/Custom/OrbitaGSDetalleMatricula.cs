...
{
    /// <summary>
    /// Control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula asociado a los eventos de comunicaciones
    /// </summary>
    public partial class OrbitaGSDetalleMatricula : OrbitaControlBaseEventosComs
    {
        /// <summary>
        /// Clase de las propiedades del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        public new class ControlNuevaDefinicion : OGSDetalleMatricula
        {
            public ControlNuevaDefinicion(OrbitaGSDetalleMatricula sender)
                : base(sender) { }
        };

        #region Atributos
        /// <summary>
        /// Definición de las propiedades del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        new ControlNuevaDefinicion definicion;
        /// <summary>
        /// Logger del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        ILogger Logger = LogManager.GetLogger("OrbitaGSDetalleMatricula");
        #endregion

        #region Delegados
        /// <summary>
        /// Delegado para el click del bRecodificar del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoRecodificarClickMatricula(object sender, EventArgs e);
        /// <summary>
        /// Delegado para el keypress del txtRecod del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoRecodKeyPressMatricula(object sender, KeyEventArgs e);
        /// <summary>
        /// Delegado para el keypress del txtRecodTOS del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoRecodTOSKeyPressMatricula(object sender, KeyEventArgs e);
        /// <summary>
        /// Delegado para el cambio de dato del lblInspeccion del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoCambioDatoInspeccionMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para el cambio de dato del lblRecod del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoCambioDatoRecodMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para el cambio de dato del lblRecodTOS del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoCambioDatoRecodTOSMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para el cambio de dato del lblFiabilidad del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoCambioDatoFiabilidadMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la Alarma del lblInspeccion del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoAlarmaInspeccionMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la Alarma del lblRecod del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoAlarmaRecodMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la Alarma del lblRecodTOS del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoAlarmaRecodTOSMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la Alarma del lblFiabilidad del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoAlarmaFiabilidadMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la Comunicacion del lblInspeccion del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoComunicacionInspeccionMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la Comunicacion del lblRecod del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoComunicacionRecodMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la Comunicacion del lblRecodTOS del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void DelegadoComunicacionRecodTOSMatricula(object sender, OEventArgs e);
        /// <summary>
        /// Delegado para la Comunicacion del lblFiabilidad del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        #region Propiedades
        /// <summary>
        /// Obtiene o establece las propiedades del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
        ...
        /// </summary>
        public OrbitaGSDetalleMatricula()
        {
            InitializeComponent();
        ...
        /// <summary>
        /// Evento que se lanza en el click de bRecodificar 
        /// </summary>
        public event DelegadoRecodificarClickMatricula OnRecodificarClickMatricula;
        /// <summary>
        /// Evento que se lanza en el keypress de txtRecod 
        /// </summary>
        public event DelegadoRecodKeyPressMatricula OnRecodKeyPressMatricula;
        /// <summary>
        /// Evento que se lanza en el keypress de txtRecodTOS
        /// </summary>
        ...
        private void copiarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                Logger.Error("Error en copiarToolStripMenuItem_Click de Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula", ex);
            }
        }
        private void cmsCopiar_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                Logger.Error("Error en cmsCopiar_Opening de Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula", ex);
            }
        }
        private void cmsCopiar_Closing(object sender, ToolStripDropDownClosingEventArgs e)
        {
            ...
            {
                Logger.Error("Error en cmsCopiar_Closing de Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula", ex);
            }
        }
        #endregion
        ...
        #region Matricula
        /// <summary>
        /// Lanza el evento click de bRecodificar del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.        
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>        
        private void bRecodificarMatricula_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.OnRecodificarClickMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "Procesar en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.bRecodificarMatricula_Click");
                        }
                    }
                }
            }
            ...
            {
                Logger.Error(ex, "Procesar evento click en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.bRecodificarMatricula_Click");
            }
        }
        /// <summary>
        /// Lanza el evento OnKeyPrss del txtRecod del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula con el cambio de dato de una de las variables asociadas al Cambio.        
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void txtRecodMatricula_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                ...
                if (this.OnRecodKeyPressMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "Procesar en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.txtRecodMatricula_KeyPress");
                        }
                    }
                }
            }
            ...
            {
                Logger.Error(ex, "Procesar evento keypress en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.txtRecodMatricula_KeyPress");
            }
        }
        /// <summary>
        /// Lanza el evento OnKeyPrss del txtRecodTOS del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula con el cambio de dato de una de las variables asociadas al Cambio.        
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void txtRecodTOSMatricula_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                ...
                if (this.OnRecodTOSKeyPressMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "Procesar en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.txtRecodTOSMatricula_KeyPress");
                        }
                    }
                }
            }
            ...
            {
                Logger.Error(ex, "Procesar evento keypress en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.txtRecodTOSMatricula_KeyPress");
            }
        }
        #region Inspeccion
        /// <summary>
        /// Lanza el evento OnCambio del lblInspeccion del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula con el cambio de dato de una de las variables asociadas al Cambio.        
        /// </summary>
        /// <param name="e"></param>
        private void lblInspeccionMatricula_OnCambioDato(object sender, Utiles.OEventArgs e)
        {
            try
            {
                ...
                if (this.OnCambioDatoInspeccionMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarCambioDato en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblInspeccionMatricula_OnCambioDato");
                        }
                    }
                }
            }
            ...
            try
            {
                ...
                if (this.OnAlarmaInspeccionMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarAlarma en Orbita.Controles.GateSuite.OrbitaGSInspeccionMatricula.lblInspeccionMatricula_OnAlarma");
                        }
                    }
                }
            }
            ...
            try
            {
                ...
                if (this.OnComunicacionInspeccionMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarComunicacion en Orbita.Controles.GateSuite.OrbitaGSInspeccionMatricula.lblInspeccionMatricula_OnComunicacion");
                        }
                    }
                }
            }
        ...
        #region Recod
        /// <summary>
        /// Lanza el evanto OnCambio del lblRecod del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula con el cambio de dato de una de las variables asociadas al Cambio.        
        /// </summary>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnCambioDatoRecodMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarCambioDato en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblRecodMatricula_OnCambioDato");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Lanza el evanto OnAlarma del lblRecod del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula con la alarma de una de las variables asociadas a la Alarma.        
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnAlarmaRecodMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarAlarma en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblRecodMatricula_OnAlarma");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Lanza el evento OnComunicacion del lblRecod del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnComunicacionRecodMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarComunicacion en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblRecodMatricula_OnComunicacion");
                        }
                    }
                }
            }
        ...
        #region RecodTOS
        /// <summary>
        /// Lanza el evento OnCambio del lblRecodTOS del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula con el cambio de dato de una de las variables asociadas al Cambio.        
        /// </summary>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnCambioDatoRecodTOSMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarCambioDato en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblRecodTOS_OnCambioDato");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Lanza el evento OnAlarma del lblRecodTOS del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula con la alarma de una de las variables asociadas a la Alarma.        
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnAlarmaRecodTOSMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarAlarma en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblRecodTOS_OnAlarma");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Lanza el evento OnComunicacion del lblRecodTOS del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnComunicacionRecodTOSMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarComunicacion en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblRecodTOS_OnComunicacion");
                        }
                    }
                }
            }
        ...
        #region Fiabilidad
        /// <summary>
        /// Lanza el evento OnCambio del lblFiabilidad del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula con el cambio de dato de una de las variables asociadas al Cambio.        
        /// </summary>
        /// <param name="e"></param>
        private void lblFiabilidadMatricula_OnCambioDato(object sender, OEventArgs e)
        {
            try
            {
                ...
                if (this.OnCambioDatoFiabilidadMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarCambioDato en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblFiabilidadMatricula_OnCambioDato");
                        }
                    }
                }
            }
            ...
            {
                Logger.Error(ex, "ProcesarCambioDato en Orbita.Controles.GateSuite.OrbitaGSInspeccionFiabilidad.lblFiabilidadMatricula_OnCambioDato");
            }
        }
        /// <summary>
        /// Lanza el evento OnAlarma del lblFiabilidad del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula con la alarma de una de las variables asociadas a la Alarma.        
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnAlarmaFiabilidadMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarAlarma en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblFiabilidadMatricula_OnAlarma");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Lanza el evento OnComunicacion del lblFiabilidad del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula 
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
            ...
            try
            {
                ...
                if (this.OnComunicacionFiabilidadMatricula != null)
                {
                    ...
                    foreach (Delegate d in eventHandlers)
                    {
                        ...
                        {
                            Logger.Error(ex, "ProcesarComunicacion en Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula.lblFiabilidadMatricula_OnComunicacion");
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Inicializa los atributos de las propiedades del control Orbita.Controles.GateSuite.OrbitaGSDetalleMatricula
        /// </summary>
