...
{
    public partial class OClienteComsOPC1 : UserControl
    {
        #region Delegados
        /// <summary>
        ...
        private void cambiarEstado(OEstadoComms estado)
        {
            if (estado.Estado == "OK")
            {
                if (estado.Id == this._idDispositivo)
                {
                    ...
                    {
                        this.txtOPC.BackColor = System.Drawing.Color.Green;
                    }
                }
            }
            else
            {
                if (estado.Id == this._idDispositivo)
                {
                    ...
                    {
                        this.txtOPC.BackColor = System.Drawing.Color.Red;
                    }
                }
            }
        }
        ...
        private void agregarItemOPC(string texto)
        {
            if (this.listViewOPC.InvokeRequired)
            {
                Delegado MyDelegado = new Delegado(agregarItemOPC);
            ...
            else
            {
                ...
                //lvi.ImageIndex = 0;
                lvi.Tag = texto;
                this.listViewOPC.Items.Add(lvi);
            }
        }       
        ...
        private void btnEscrituraOPC_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                variable[0] = this.txtVarEscribirOPC.Text;
                object[] valor = new object[1];
                valor[0] = this.txtValEscribirOPC.Text;
                //valor[0] = dt;
        ...
        private void btnLeerVariablesOPC_Click(object sender, EventArgs e)
        {
            ...
            this.dataGridViewOPC.DataSource = dt;
        }
        /// <summary>
