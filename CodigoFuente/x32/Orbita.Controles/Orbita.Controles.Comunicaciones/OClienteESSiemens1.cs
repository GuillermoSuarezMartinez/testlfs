...
{
    public partial class OClienteESSiemens1 : UserControl
    {
        #region Delegados
        /// <summary>
        ...
        private void cambiarEstado(OEstadoComms estado)
        {
            if (estado.Estado == "OK")
            {
                ...
                {
                    this.txtSiemens.BackColor = System.Drawing.Color.Green;
                }
            }
            else
            {
                if (estado.Id == this._idDispositivo)
                {
                    this.txtSiemens.BackColor = System.Drawing.Color.Red;
                }
            }
        }
        /// <summary>
            ...
            else
            {
                ...
                switch (dato.Texto)
                {
                    case "S01":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS01.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS01.BackColor = Color.Beige;
                        }
                        break;
                    case "S02":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS02.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS02.BackColor = Color.Beige;
                        }
                        break;
                    case "S03":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS03.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS03.BackColor = Color.Beige;
                        }
                        break;
                    case "S04":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS04.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS04.BackColor = Color.Beige;
                        }
                        break;
                    case "S05":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS05.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS05.BackColor = Color.Beige;
                        }
                        break;
                    case "S06":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS06.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS06.BackColor = Color.Beige;
                        }
                        break;
                    case "S07":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS07.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS07.BackColor = Color.Beige;
                        }
                        break;
                    case "S08":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS08.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS08.BackColor = Color.Beige;
                        }
                        break;
                    case "S11":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS11.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS11.BackColor = Color.Beige;
                        }
                        break;
                    case "S12":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensS12.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensS12.BackColor = Color.Beige;
                        }
                        break;
                    case "E01":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE01.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE01.BackColor = Color.Beige;
                        }
                        break;
                    case "E02":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE02.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE02.BackColor = Color.Beige;
                        }
                        break;
                    case "E03":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE03.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE03.BackColor = Color.Beige;
                        }
                        break;
                    case "E04":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE04.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE04.BackColor = Color.Beige;
                        }
                        break;
                    case "E05":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE05.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE05.BackColor = Color.Beige;
                        }
                        break;
                    case "E06":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE06.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE06.BackColor = Color.Beige;
                        }
                        break;
                    case "E07":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE07.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE07.BackColor = Color.Beige;
                        }
                        break;
                    case "E08":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE08.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE08.BackColor = Color.Beige;
                        }
                        break;
                    case "E11":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE11.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE11.BackColor = Color.Beige;
                        }
                        break;
                    case "E12":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE12.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE12.BackColor = Color.Beige;
                        }
                        break;
                    case "E13":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE13.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE13.BackColor = Color.Beige;
                        }
                        break;
                    case "E14":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE14.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE14.BackColor = Color.Beige;
                        }
                        break;
                    case "E15":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE15.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE15.BackColor = Color.Beige;
                        }
                        break;
                    case "E16":
                        if ((int)dato.Valor == 1)
                        {
                            this.SiemensE16.BackColor = Color.Orange;
                        }
                        else
                        {
                            this.SiemensE16.BackColor = Color.Beige;
                        }
                        break;
                    default:
                        break;
        ...
        private void btnEscrituraOPC_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                variable[0] = this.txtVarEscribirSiemens.Text;
                object[] valor = new object[1];
                valor[0] = this.txtValEscribirSiemens.Text;
                //valor[0] = dt;
