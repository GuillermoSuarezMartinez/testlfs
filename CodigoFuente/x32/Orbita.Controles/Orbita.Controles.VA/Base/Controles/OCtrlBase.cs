...
namespace Orbita.Controles.VA
{
    ...
    /// </summary>          
    public partial class OCtrlBase : UserControl, IOrbitaForm, IDisposable
    {
        #region Atributo(s)
        /// <summary>
        ...
        public OCtrlBase(Control contendor, ModoAperturaFormulario modoFormulario)
        {
            InitializeComponent();
        ...
        private void FrmBase_Activated(object sender, EventArgs e)
        {
            ...
            {
                OVALogsManager.Error(OModulosSistema.Escritorios, "Activación del control", exception);
            }
        }
        /// <summary>
