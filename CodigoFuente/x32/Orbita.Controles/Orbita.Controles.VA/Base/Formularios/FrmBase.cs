...
namespace Orbita.Controles.VA
{
    ...
    public partial class FrmBase : OrbitaForm, IOrbitaForm, IDisposable
    {
        ...
        private void ChkDock_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                OVALogsManager.Error(ModulosSistema.Escritorios, "Clic en botón de anclaje", exception);
            }
        }
        /// <summary>
        ...
        private void FrmBase_AfterPaneButtonClick(object sender, PaneButtonEventArgs e)
        {
            ...
            {
                OVALogsManager.Error(ModulosSistema.Escritorios, "Clic en botón cerrar del anclaje", exception);
            }
        }
        /// <summary>
        ...
        private void FrmBase_AfterDockChange(object sender, PaneEventArgs e)
        {
            ...
            {
                OVALogsManager.Error(ModulosSistema.Escritorios, "Formulario cambiado de anclaje", exception);
            }
        }
