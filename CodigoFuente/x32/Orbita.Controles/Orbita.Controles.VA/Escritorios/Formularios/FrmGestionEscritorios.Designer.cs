...
{
    partial class FrmGestionEscritorios
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmGestionEscritorios));
            Infragistics.Win.Appearance appearance8 = new Infragistics.Win.Appearance();
            Infragistics.Win.UltraWinTabControl.UltraTab ultraTab1 = new Infragistics.Win.UltraWinTabControl.UltraTab();
            Infragistics.Win.UltraWinTabControl.UltraTab ultraTab2 = new Infragistics.Win.UltraWinTabControl.UltraTab();
            this.ultraTabPageControl1 = new Infragistics.Win.UltraWinTabControl.UltraTabPageControl();
            this.GrpConfigEscritorio = new Orbita.Controles.OrbitaGroupBox(this.components);
            this.lblAnclaje = new Orbita.Controles.OrbitaLabel(this.components);
            this.checkAnclaje = new Orbita.Controles.OrbitaCheckBox();
            this.PnlOpcionesEscritorios = new Orbita.Controles.OrbitaPanel();
            this.checkPreferenciaMaximizado = new Orbita.Controles.OrbitaCheckBox();
            this.lblPreferenciaMaximizado = new Orbita.Controles.OrbitaLabel(this.components);
            this.cboEscritorios = new Orbita.Controles.OrbitaComboPro();
            this.checkAutoAbrirFoms = new Orbita.Controles.OrbitaCheckBox();
            this.lblConfigEscritorio = new Orbita.Controles.OrbitaLabel(this.components);
            this.lblAutoAbrirFoms = new Orbita.Controles.OrbitaLabel(this.components);
            this.lblHabilitado = new Orbita.Controles.OrbitaLabel(this.components);
            this.checkHabilitado = new Orbita.Controles.OrbitaCheckBox();
            this.PnlGeneral = new Orbita.Controles.OrbitaPanel();
            this.lblExplicacionGeneral = new Orbita.Controles.OrbitaLabel(this.components);
            this.ImgGeneral = new Orbita.Controles.OrbitaPictureBox(this.components);
            this.ultraTabPageControl2 = new Infragistics.Win.UltraWinTabControl.UltraTabPageControl();
            this.GrpListaEscritorios = new Orbita.Controles.OrbitaGroupBox(this.components);
            this.lblListadoEscritorios = new Orbita.Controles.OrbitaLabel(this.components);
            this.GridEscritorios = new Orbita.Controles.OrbitaGridPro();
            this.PnlEscritorios = new Orbita.Controles.OrbitaPanel();
            this.orbitaLabel5 = new Orbita.Controles.OrbitaLabel(this.components);
            this.ImgEscritorios = new Orbita.Controles.OrbitaPictureBox(this.components);
            this.lblExplicacionEscritorios = new Orbita.Controles.OrbitaTabControl();
            ...
            // GrpConfigEscritorio
            // 
            this.GrpConfigEscritorio.ContentPadding.Bottom = 2;
            ...
            // ImgGeneral
            // 
            this.ImgGeneral.Image = global::Orbita.Controles.VA.Properties.Resources.imgWindows48;
            this.ImgGeneral.InitialImage = null;
            this.ImgGeneral.Location = new System.Drawing.Point(19, 21);
            this.ImgGeneral.Name = "ImgGeneral";
            this.ImgGeneral.Size = new System.Drawing.Size(48, 48);
            ...
            // GrpListaEscritorios
            // 
            this.GrpListaEscritorios.ContentPadding.Bottom = 2;
            ...
            this.PnlEscritorios.Name = "PnlEscritorios";
            ...
            // ImgEscritorios
            // 
            this.ImgEscritorios.Image = global::Orbita.Controles.VA.Properties.Resources.imgDesktop48;
            this.ImgEscritorios.Location = new System.Drawing.Point(19, 21);
            this.ImgEscritorios.Name = "ImgEscritorios";
            this.ImgEscritorios.Size = new System.Drawing.Size(48, 48);
        ...
        private Orbita.Controles.OrbitaLabel lblHabilitado;
        private Orbita.Controles.OrbitaCheckBox checkHabilitado;
        private Orbita.Controles.OrbitaLabel lblConfigEscritorio;
        private Orbita.Controles.OrbitaLabel lblPreferenciaMaximizado;
        private Orbita.Controles.OrbitaCheckBox checkPreferenciaMaximizado;
        private Orbita.Controles.OrbitaLabel lblAutoAbrirFoms;
        private Orbita.Controles.OrbitaCheckBox checkAutoAbrirFoms;
        private Orbita.Controles.OrbitaComboPro cboEscritorios;
        private Orbita.Controles.OrbitaPictureBox ImgGeneral;
        private Orbita.Controles.OrbitaGroupBox GrpConfigEscritorio;
        private Orbita.Controles.OrbitaLabel lblExplicacionGeneral;
        private Orbita.Controles.OrbitaTabControl lblExplicacionEscritorios;
        private Infragistics.Win.UltraWinTabControl.UltraTabSharedControlsPage ultraTabSharedControlsPage1;
        private Infragistics.Win.UltraWinTabControl.UltraTabPageControl ultraTabPageControl1;
        private Infragistics.Win.UltraWinTabControl.UltraTabPageControl ultraTabPageControl2;
        private Orbita.Controles.OrbitaPanel PnlGeneral;
        private Orbita.Controles.OrbitaPictureBox ImgEscritorios;
        private Orbita.Controles.OrbitaGroupBox GrpListaEscritorios;
        private Orbita.Controles.OrbitaPanel PnlEscritorios;
        private Orbita.Controles.OrbitaLabel orbitaLabel5;
        private Orbita.Controles.OrbitaLabel lblListadoEscritorios;
        private Orbita.Controles.OrbitaGridPro GridEscritorios;
        private Orbita.Controles.OrbitaPanel PnlOpcionesEscritorios;
        private Orbita.Controles.OrbitaLabel lblAnclaje;
        private Orbita.Controles.OrbitaCheckBox checkAnclaje;
    }
}