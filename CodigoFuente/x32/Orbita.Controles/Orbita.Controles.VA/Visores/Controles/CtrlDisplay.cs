...
namespace Orbita.Controles.VA
{
    ...
    public partial class CtrlDisplay : UserControl
    {
        ...
        protected void MostrarInfoDispositivo()
        {
            ...
            {
                this.OnInfoDemandada(this, new EventInfoRequiredArgs(this.Codigo));
            }
        }
        ...
        public void OnNuevaFotografiaCamara(OrbitaImage imagen)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="estadoConexion"></param>
        public void OnCambioEstadoConexionCamara(EstadoConexion estadoConexion)
        {
            try
            {
        ...
        public event VisorInfoDemandada OnInfoDemandada;
        #endregion
    }
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    public delegate void VisorInfoDemandada(object sender, EventInfoRequiredArgs e);

    /// <summary>
    /// Parametros de retorno del evento de cambio de maximizado o restaurado de la ventana
    /// </summary>
    public class EventInfoRequiredArgs : EventArgs
    {
        #region Atributo(s)
        /// <summary>
        /// Código de la cámara
        ...
        /// <param name="codEstado">Código del estado visual</param>
        /// <param name="posicion">Posición del estado visual</param>
        public EventInfoRequiredArgs(string codCamara)
        {
            this.CodCamara = codCamara;
        }
        #endregion
