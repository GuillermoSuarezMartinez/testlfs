...
namespace Orbita.Controles.VA
{
    ...
    /// </summary>
    public partial class OVisorBitmap : OVisorBase
    {
        #region Atributo(s)
        /// <summary>
        ...
        public OVisorBitmap(string titulo, string codCamara, double maxFrameIntervalVisualizacion, bool asociarCamara, bool visualizarEnVivo) :
