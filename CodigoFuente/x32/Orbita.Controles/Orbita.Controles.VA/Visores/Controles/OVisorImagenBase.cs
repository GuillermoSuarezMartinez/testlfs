...
namespace Orbita.Controles.VA
{
    ...
    /// </summary>
    public partial class OVisorBase : UserControl
    {
        #region Atributos
        /// <summary>
        ...
        public OVisorBase(string titulo, string codCamara, double maxFrameIntervalVisualizacion, bool asociarCamara, bool visualizarEnVivo)
        {
            InitializeComponent();
