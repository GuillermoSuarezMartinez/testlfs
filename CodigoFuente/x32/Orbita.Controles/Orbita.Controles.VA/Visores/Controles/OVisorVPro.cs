...
namespace Orbita.Controles.VA
{
    ...
    /// </summary>
    public partial class OVisorVPro : OVisorBase
    {
        #region Atributo(s)
        /// <summary>
        ...
        public OVisorVPro(string titulo, string codCamara, double maxFrameIntervalVisualizacion, bool asociarCamara, bool visualizarEnVivo) :
