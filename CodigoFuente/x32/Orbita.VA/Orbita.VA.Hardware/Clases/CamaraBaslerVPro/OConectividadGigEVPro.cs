...
namespace Orbita.VA.Hardware
{
    ...
    /// </summary>
    public class OConectividadGigEVPro: OConectividad
    {
        #region Atributo(s)
        /// <summary>
        ...
        /// </summary>
        private OVProGigEIntFeature FeatureGigeConexion;
        #endregion
        ...
        /// </summary>
        public OConectividadGigEVPro(string codigo, OVProGigEIntFeature featureGigeConexion, int intervaloComprobacionMs) :
            base(codigo)
        {
