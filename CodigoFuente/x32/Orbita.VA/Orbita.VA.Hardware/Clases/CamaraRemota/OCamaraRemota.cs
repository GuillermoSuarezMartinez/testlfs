...
namespace Orbita.VA.Hardware
{
    ...
    internal class ORemotingCamaraProxie : ORemotingProxie<ORemotingCamaraServidor>
    {
        ...
        public bool Existe
        {
            get 
            {
                ...
                try
                {
                    ...
                    {
                        resultado = this.Instancia.GetExiste();
                    }
                }
                catch { };
                return resultado; 
        ...
        public TipoImagen TipoImagen
        {
            get 
            { 
                return this.Instancia.GetTipoImagen();
            }
        }
        #endregion
        ...
        public void Enlazar()
        {
            try
            {
                this.Instancia.Enlazar(this.CodigoCliente, this.CodigoRemoto);
            }
            catch (Exception exception)
            {
        ...
        public bool StartREC(string fichero)
        {
            ...
            try
            {
                resultado = this.Instancia.StartREC(fichero);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public bool StopREC()
        {
            ...
            try
            {
                resultado = this.Instancia.StopREC();
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public bool SetAjuste(string codAjuste, object valor)
        {
            ...
            try
            {
                resultado = this.Instancia.SetAjuste(codAjuste, valor);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public bool GetAjuste(string codAjuste, out object valor)
        {
            ...
            try
            {
                resultado = this.Instancia.GetAjuste(codAjuste, out valor);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public bool PTZHabilitado()
        {
            ...
            try
            {
                resultado = this.Instancia.PTZHabilitado();
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public bool EjecutaMovimientoPTZ(OEnumTipoMovimientoPTZ tipo, OEnumModoMovimientoPTZ modo, double valor)
        {
            ...
            try
            {
                resultado = this.Instancia.EjecutaMovimientoPTZ(tipo, modo, valor);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public bool EjecutaMovimientoPTZ(OMovimientoPTZ movimiento, double valor)
        {
            ...
            try
            {
                resultado = this.Instancia.EjecutaMovimientoPTZ(movimiento, valor);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public bool EjecutaMovimientoPTZ(OComandoPTZ comando)
        {
            ...
            try
            {
                resultado = this.Instancia.EjecutaMovimientoPTZ(comando);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public bool EjecutaMovimientoPTZ(OComandosPTZ valores)
        {
            ...
            try
            {
                resultado = this.Instancia.EjecutaMovimientoPTZ(valores);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public OPosicionesPTZ ConsultaPosicionPTZ()
        {
            ...
            try
            {
                resultado = this.Instancia.ConsultaPosicionPTZ();
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public OPosicionPTZ ConsultaPosicionPTZ(OEnumTipoMovimientoPTZ movimiento)
        {
            ...
            try
            {
                resultado = this.Instancia.ConsultaPosicionPTZ(movimiento);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public OPosicionesPTZ ConsultaUltimaPosicionPTZ()
        {
            ...
            try
            {
                resultado = this.Instancia.ConsultaUltimaPosicionPTZ();
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public bool GuardarImagenADisco(string ruta)
        {
            ...
            try
            {
                resultado = this.Instancia.GuardarImagenADisco(ruta);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void CrearSuscripcionNuevaFotografiaMemoriaMapeada(EventoNuevaFotografiaCamaraMemoriaMapeada delegadoNuevaFotografiaCamaraMemoriaMapeada)
        {
            try
            {
                this.Instancia.CrearSuscripcionNuevaFotografiaMemoriaMapeada(this.CodigoCliente, delegadoNuevaFotografiaCamaraMemoriaMapeada);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void EliminarSuscripcionNuevaFotografiaMemoriaMapeada(EventoNuevaFotografiaCamaraMemoriaMapeada delegadoNuevaFotografiaCamaraMemoriaMapeada)
        {
            try
            {
                this.Instancia.EliminarSuscripcionNuevaFotografiaMemoriaMapeada(this.CodigoCliente, delegadoNuevaFotografiaCamaraMemoriaMapeada);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void CrearSuscripcionNuevaFotografiaRemota(EventoNuevaFotografiaCamaraRemota delegadoNuevaFotografiaCamaraRemota)
        {
            try
            {
                this.Instancia.CrearSuscripcionNuevaFotografiaRemota(this.CodigoCliente, delegadoNuevaFotografiaCamaraRemota);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void EliminarSuscripcionNuevaFotografiaRemota(EventoNuevaFotografiaCamaraRemota delegadoNuevaFotografiaCamaraRemota)
        {
            try
            {
                this.Instancia.EliminarSuscripcionNuevaFotografiaRemota(this.CodigoCliente, delegadoNuevaFotografiaCamaraRemota);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void CrearSuscripcionCambioEstadoConexion(EventoCambioEstadoConexionCamara delegadoCambioEstadoConexionCamara)
        {
            try
            {
                this.Instancia.CrearSuscripcionCambioEstadoConexion(this.CodigoCliente, delegadoCambioEstadoConexionCamara);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void EliminarSuscripcionCambioEstadoConexion(EventoCambioEstadoConexionCamara delegadoCambioEstadoConexionCamara)
        {
            try
            {
                this.Instancia.EliminarSuscripcionCambioEstadoConexion(this.CodigoCliente, delegadoCambioEstadoConexionCamara);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void CrearSuscripcionCambioEstadoReproduccion(EventoCambioEstadoReproduccionCamara delegadoCambioEstadoReproduccionCamara)
        {
            try
            {
                this.Instancia.CrearSuscripcionCambioEstadoReproduccion(this.CodigoCliente, delegadoCambioEstadoReproduccionCamara);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void EliminarSuscripcionCambioEstadoReproduccion(EventoCambioEstadoReproduccionCamara delegadoCambioEstadoReproduccionCamara)
        {
            try
            {
                this.Instancia.EliminarSuscripcionCambioEstadoReproduccion(this.CodigoCliente, delegadoCambioEstadoReproduccionCamara);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void CrearSuscripcionMensajes(OMessageEvent messageDelegate)
        {
            try
            {
                this.Instancia.CrearSuscripcionMensajes(this.CodigoCliente, messageDelegate);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void EliminarSuscripcionMensajes(OMessageEvent messageDelegate)
        {
            try
            {
                this.Instancia.EliminarSuscripcionMensajes(this.CodigoCliente, messageDelegate);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void CrearSuscripcionBitVida(ManejadorEvento messageDelegate)
        {
            try
            {
                this.Instancia.CrearSuscripcionBitVida(this.CodigoCliente, messageDelegate);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
        ...
        public void EliminarSuscripcionBitVida(ManejadorEvento messageDelegate)
        {
            try
            {
                this.Instancia.EliminarSuscripcionBitVida(this.CodigoCliente, messageDelegate);
            }
            catch (Exception exception)
            {
                OLogsVAHardware.Camaras.Error(exception, this.CodigoRemoto);
