...
namespace Orbita.VA.Hardware
{
    ...
    /// </summary>
    public class OIO_SCED : OModuloIOBase
    {
        #region Atributo(s)
        /// <summary>
        ...
        public override void Inicializar()
        {
            try
            {
                ...
                if ((this.Habilitado) && (this._Valido))
                {
                    ...
                    foreach (OTerminalIOSCED terminal in this.ListaTerminales.Values)
                    {
        ...
        void eventWrapper_OrbitaCambioDato(OEventArgs e)
        {
            try
            {
                ...
                OTerminalIOSCED terminal = this.ListaTerminales.Values.OfType<OTerminalIOSCED>().Single(t => (t.CodigoVariableSCED == codigoCambioEstado) && (t.IdDispositivo == dispositivo));
                if (terminal != null)
                {
                    // Extraemos el valor
    ...
    internal class OTerminalIOSCED_WriteCommand : OTerminalIOSCED
    {
        ...
        public override void Inicializar()
        {
            ...
            foreach (string codTerminalIOAsociado in this.ListaCodigosTerminalesAsociados)
            {
                ...
                {
                    this.ListaTerminalesAsociados.Add((OTerminalIOSCED)terminalAsociado);
                }
            }
        }
