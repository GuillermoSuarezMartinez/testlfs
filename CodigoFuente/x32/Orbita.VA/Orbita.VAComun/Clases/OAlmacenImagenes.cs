...
namespace Orbita.VA.Comun
{
    ...
    public static class OAlmacenImagenesManager
    {
        ...
        public static void GuardarImagen(string ruta, OImage imagen)
        {
    ...
    internal class AlmacenImagenes : IDisposable
    {
        ...
        /// </summary>
        private Queue<KeyValuePair<string, OImage>> ColaImagenes;
        ...
        private void Ejecutar(ref bool finalize)
        {
            try
            {
                ...
                {
                    KeyValuePair<string, OImage> pareja = new KeyValuePair<string, OImage>();

                    lock (this.ColaImagenes)
                    {
                        pareja = this.ColaImagenes.Dequeue();
                    }
                    OImage imagen = pareja.Value;
        ...
        /// <param name="ruta">Ruta donde se ha de guardar la imagen</param>
        /// <param name="imagen">Imagen a guardar</param>
        public void GuardarImagen(string ruta, OImage imagen)
        {
            // Se clona la imagen
            OImage imagenClonada = (OImage)imagen.Clone();

            // Se crea la pareja de ruta + imagen
            KeyValuePair<string, OImage> pareja = new KeyValuePair<string, OImage>(ruta, imagenClonada);
