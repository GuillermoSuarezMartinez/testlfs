...
namespace Orbita.VAHardware
{
    ...
    public class ModulosHardware: ModulosSistema
    {
        ...
        /// </summary>
        public static EnumModulosSistema CamaraBalserPylon = new EnumModulosSistema("CamaraBalserPylon", "Módulo de funcionamiento de las cámaras Basler mediante el driver de Pylon", 211);
        #endregion
    }
}
