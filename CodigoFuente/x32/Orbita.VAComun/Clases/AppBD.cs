...
namespace Orbita.VAComun
{
    ...
    public static class AppBD
    {
        ...
        /// </summary>
        public static string DataFile = Path.Combine(RutaParametrizable.AppFolder, "Configuracion_Datos.xml");
        #endregion
        ...
        public static void CreateXMLDataBase(Dictionary<string, string> tablas)
        {
            ...
            foreach (KeyValuePair<string, string> tabla in tablas)
            {
                ...
                DataTable dt = BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("APP_GET_SELECT_A_MEDIDA", list);
        ...
        {
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("APP_GET_PARAMETROS");
        }
        ...
        {
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("VST_GET_VISTAS");
        }
        /// <summary>
        ...
        public static DataTable GetVista(string codVista)
        {
            ...
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("VST_GET_VISTA", list);
        }
        ...
        {
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("USU_GET_USUARIOS");
        }
        /// <summary>
        /// Consulta un usuario existente en el sistema
        /// </summary>
        ...
        public static DataTable GetUsuario(string codigo)
        {
            ...
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("USU_GET_USUARIO", list);
        }
        #endregion
        ...
        /// </summary>
        /// <returns></returns>        
        public static int AddHistoricoSerie(bool resultado, DateTime fecha, bool inspeccionado, string excepcion, bool rechazado, TimeSpan tiempoProceso, int IdTipoHistorico, CXML xMLDetalle, CXML xMLClaves)
        {
            ArrayList list = new ArrayList();
            ...
            return BaseDatosAlmacen.SQLServer.EjecutarProcedimientoAlmacenado("HIS_ADD_HISTORICO_SERIE_XML", list);
        }
        ...
        /// </summary>
        /// <returns></returns>        
        public static int AddHistoricoSubInspeccionSerie(int idHistorico, bool resultado, bool inspeccionado, string excepcion, TimeSpan tiempoProceso, CXML xMLDetalle)
        {
            ArrayList list = new ArrayList();
            ...
            return BaseDatosAlmacen.SQLServer.EjecutarProcedimientoAlmacenado("HIS_ADD_HISTORICO_SUBINSPECCION_SERIE_XML", list);
        }
        ...
        /// </summary>
        /// <returns></returns>        
        public static int AddHistoricoParalelo(int IdTipoHistorico, CXML xMLDetalle, CXML xMLClaves, CXML xMLSubDetalle)
        {
            ArrayList list = new ArrayList();
            ...
            return BaseDatosAlmacen.SQLServer.EjecutarProcedimientoAlmacenado("HIS_ADD_HISTORICO_PARALELO_XML", list);
        }
        #endregion
