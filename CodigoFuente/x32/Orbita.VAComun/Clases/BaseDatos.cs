...
namespace Orbita.VAComun
{
    ...
    /// </summary>
    public static class BaseDatosParam
    {
        #region Propiedad(es)
        /// <summary>
        ...
        public static OSqlServer SQLServer
        {
            get
            {
                return BaseDatosRuntime.SQLServer(OrigenBaseDatos.Parametrizacion);
            }
        }
        #endregion
        ...
        {
            BaseDatosRuntime.NuevaBaseDatos(OrigenBaseDatos.Parametrizacion);
        }
        ...
        {
            return BaseDatosRuntime.ObtenerConnectionString(OrigenBaseDatos.Parametrizacion);
        }
        #endregion
    }
    ...
    /// Utiliza BaseDatosRuntime especificando como origen la base datos de parametrización
    /// </summary>
    public static class BaseDatosAlmacen
    {
        #region Propiedad(es)
        /// <summary>
        ///  Acceso a la base de datos SQL Server
        ...
        public static OSqlServer SQLServer
        {
            get
            {
                return BaseDatosRuntime.SQLServer(OrigenBaseDatos.Almacen);
            }
        }
        #endregion
        ...
        public static void Conectar()
        {
            BaseDatosRuntime.NuevaBaseDatos(OrigenBaseDatos.Almacen);
        }
        ...
        public static string ObtenerConnectionString()
        {
            return BaseDatosRuntime.ObtenerConnectionString(OrigenBaseDatos.Almacen);
        }
        #endregion
    }
    ...
    /// </summary>
    public static class BaseDatosRuntime
    {
        #region Atributo(s)
        /// <summary>
        /// Lista de las bases de datos existentes en el sistema
        /// </summary>
        public static List<BaseDatos> ListaBaseDatos;
        #endregion
        ...
        {
            ListaBaseDatos = new List<BaseDatos>();
        }
        ...
        {
            BaseDatos baseDatos = new BaseDatos(enumOrigenBaseDatos);
        ...
        {
            BaseDatos baseDatos = ListaBaseDatos.Find(delegate(BaseDatos bd) { return bd.Origen == origenBaseDatos; });
            if (baseDatos != null)
            {
    ...
    public class BaseDatos
    {
        ...
        /// </summary>
        public InformacionBasesDatos InformacionBasesDatos;
        #endregion
        ...
        public OSqlServer SQLServer
        {
            get
            {
                InfoConexion info = this.CrearInformacionSQL();
        ...
        public BaseDatos(EnumOrigenBaseDatos origen)
        {
            this.Origen = origen;

            this.InformacionBasesDatos = SystemRuntime.Configuracion.ListaInformacionBasesDatos.Find(delegate(InformacionBasesDatos info) { return info.Origen.Equals(origen.Nombre); });
        }
        #endregion
        ...
        private InfoConexion CrearInformacionSQL()
        {
            InfoConexion infoConexion = new InfoConexion();
    ...
    /// </summary>
    public class EnumOrigenBaseDatos: Enumerado
    {        
        #region Constructor
        /// <summary>
