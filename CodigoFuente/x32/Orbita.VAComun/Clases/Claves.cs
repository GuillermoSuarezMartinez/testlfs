...
namespace Orbita.VAComun
{
    ...
    /// </summary>
    public class Claves: Dictionary<string, Clave>
    {
        #region Constructor
        /// <summary>
        ...
        public Claves(Claves claves): base(claves)
        {}
        #endregion
        ...
        /// <param name="claves"></param>
        /// <returns></returns>
        public bool CompararClaves(Claves claves)
        {
            bool resultado = true;

            foreach (KeyValuePair<string, Clave> clavePair in this)
            {
                Clave clavePropia = clavePair.Value;
        ...
        public Dictionary<string,object> ToDictionary()
        {
            ...
            foreach (KeyValuePair<string, Clave> pair in this)
            {
    ...
    public class Clave
    {
        ...
        public Clave(string codigo, string nombre, string descripcion, EnumTipoDato tipo, object valor, bool valorDefinido)
        {
            this._Codigo = codigo;
            this._Nombre = nombre;
