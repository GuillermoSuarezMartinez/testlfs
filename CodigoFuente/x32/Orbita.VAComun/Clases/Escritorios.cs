...
namespace Orbita.VAComun
{
    ...
    public static class EscritoriosRuntime
    {
        ...
        public static void Constructor()
        {
            if (App.IsWinForms())
            {
                ...
                OpcionesEscritorios opcionesEscritorio = SystemRuntime.Configuracion.OpcionesEscritorio;

                PermiteAnclajes = opcionesEscritorio.PermiteAnclajes;
                ManejoAvanzadoEscritorio = opcionesEscritorio.ManejoAvanzadoEscritorio;
                NombreEscritorioActual = opcionesEscritorio.NombreEscritorioActual;
                PreferenciaMaximizado = opcionesEscritorio.PreferenciaMaximizado;
                AutoAbrirFoms = opcionesEscritorio.AutoAbrirFoms;

                ListaEscritorios = new List<Escritorio>();
                foreach (OpcionesEscritorio escritorio in opcionesEscritorio.ListaOpcionesEscritorio)
                {
    ...
    /// </summary>
    [Serializable]
    public class OpcionesEscritorios
    {
        #region Atributo(s)
        /// <summary>
        /// Habilita o deshabilita la opción de anclar formularios
