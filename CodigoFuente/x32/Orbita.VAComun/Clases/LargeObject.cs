...
namespace Orbita.VAComun
{
    ...
    /// </summary>
    public static class LargeObjectsRuntime
    {
        #region Atributo(s)
        /// <summary>
		...
		public static void Constructor()
        {
            ...
            CronometroRuntime.NuevoCronometro("GarbageCollector", "LiberadorMemoria", "Liberación de memoria");
        }
        ...
        public static void RegistraEnLog(string textoFormateado)
        {
            if (ListaObjetos != null)
            {
                ...
                {
                    LogsRuntime.Info(ModulosSistema.ManejadorObjetosGrandes, "LargeObjectsRuntime", textoResumen);
                }
            }
        }
        ...
        public static void Add(LargeObjectBase baseObject)
        {
            if (ListaObjetos != null)
	        {
                lock (BlockObject)
        ...
        /// </summary>
        /// <param name="baseObject"></param>
        public static void Remove(LargeObjectBase baseObject)
        {
            if (ListaObjetos != null)
            {
                lock (BlockObject)
        ...
        {
            CronometroRuntime.Start("GarbageCollector");
            App.ColectorBasura(esperaFinalizacion);
            CronometroRuntime.Stop("GarbageCollector");
        }
	    #endregion    
    }
    ...
    /// </summary>
    public abstract class LargeObjectBase : IDisposable
    {
        ...
        public LargeObjectBase(string codigo)
        {
            this.Codigo = codigo;
            LargeObjectsRuntime.Add(this);
        } 
        #endregion
        ...
        ~LargeObjectBase()
        {
            ...
            LargeObjectsRuntime.Remove(this);
        }
