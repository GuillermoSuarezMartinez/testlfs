...
namespace Orbita.VAComun
{
    ...
    public class OrbitaImage : LargeObjectBase, ICloneable
    {
        ...
        public void GuardarAsincrono(string ruta)
        {
            if (this.EsValida())
            {
                AlmacenVisualRuntime.GuardarImagen(ruta, this);
            }
        }
        #endregion
        ...
        public virtual OrbitaImage ConvertFromBitmap(Bitmap imagenBitmap)
        {
            return null;
        }
        ...
        public virtual bool Convert<ClaseImagen>(out ClaseImagen imagen)
            where ClaseImagen : OrbitaImage, new()
        {
            imagen = null;
        ...
        public virtual OrbitaImage EscalarImagen(OrbitaImage img, int alto, int ancho)
        {
        ...
        public virtual OrbitaImage Nueva()
        {
            // Implementado en hijos
            return null;
        }
        ...
        /// <param name="height">Alto de la imagen resultado</param>
        /// <returns>Imagen reducida</returns>
        public OrbitaImage EscalarImagen(OrbitaImage img, ResolucionImagen resolucion)
        {
            int width;
            int height;
            switch (resolucion)
            {
                case ResolucionImagen.VGA:
                    width = 640;
                    height = 480;
                    break;
                case ResolucionImagen.SVGA:
                    width = 800;
                    height = 600;
                    break;
                case ResolucionImagen.Mpx1:
                    width = 1280;
                    height = 800;
                    break;
                case ResolucionImagen.Mpx1_3:
                    width = 1440;
                    height = 900;
                    break;
                case ResolucionImagen.Mpx2:
                    width = 1600;
                    height = 1200;
                    break;
                case ResolucionImagen.Mpx3:
                    width = 2048;
                    height = 1536;
                    break;
                case ResolucionImagen.Mpx4:
                    width = 640;
                    height = 480;
                    break;
                case ResolucionImagen.Mpx5:
                    width = 2560;
                    height = 1920;
                    break;
                default:
        ...
        /// <returns>Imagen reducida</returns>
        public OrbitaImage EscalarImagen(OrbitaImage img, double escalado)
        {
            if (escalado == 1)
            {
                return img;    
    ...
    /// </summary>
    [Serializable]
    public class OrbitaGrafico : IDisposable, ICloneable
    {
        #region Atributo(s)
        /// <summary>
        /// Campo donde se guarda la imagen
        ...
        /// Constructor de la clase
        /// </summary>
        public OrbitaGrafico(object grafico)
        {
        ...
        /// </summary>
        /// <param name="imagenALiberar">Variable que se desea liberar de memoria</param>
        public OrbitaGrafico(OrbitaImage graficoALiberar)
        {
            // Limpieza de memoria
        ...
        public void GuardarAsincrono(string ruta)
        {
            if (this.EsValida())
            {
                AlmacenVisualRuntime.GuardarGrafico(ruta, this);
            }
        }
        #endregion
    ...
    /// </summary>
    public class ConjuntoImagenGrafico
    {
        #region Atributo(s)
        /// <summary>
        ...
        /// Imagen
        /// </summary>
        public OrbitaImage Imagen;

        /// <summary>
        /// Gráfico
        /// </summary>
        public OrbitaGrafico Grafico;
        #endregion
        ...
        public ConjuntoImagenGrafico(string codigo, OrbitaImage imagen, OrbitaGrafico grafico)
        {
            this.Codigo = codigo;
            this.Imagen = imagen;
        ...
        /// <param name="imagen">Imagen</param>
        /// <param name="grafico">Gráfico asociado a la imagen</param>
        public ConjuntoImagenGrafico(string codigo, OrbitaImage imagen)
