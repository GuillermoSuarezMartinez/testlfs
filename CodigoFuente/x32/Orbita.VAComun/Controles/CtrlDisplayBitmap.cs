...
namespace Orbita.VAComun
{
    ...
    /// </summary>
    public partial class CtrlDisplayBitmap : CtrlDisplay
    {
        #region Atributo(s)
        /// <summary>
        ...
        public CtrlDisplayBitmap(string titulo, string codCamara, double maxFrameIntervalVisualizacion, string codVariableImagen, string codVariableGrafico) :
            base(titulo, codCamara, maxFrameIntervalVisualizacion, string.Empty, string.Empty)
        {
            InitializeComponent();
