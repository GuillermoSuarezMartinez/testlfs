...
namespace Orbita.VAComun
{
    ...
    public partial class FrmDisplays : FrmBase
    {
        ...
        /// </summary>
        public FrmDisplays(string titulo)
            :base()
        {
            InitializeComponent();
        ...
        private void CambioVentana(string codCamara, EventDeviceViewerChanged.DeviceViewerChangeOrder ordenCambioVisor)
        {
            if (this.ListaDisplays.Count > 0)
            {
                ...
                if (encontrado)
                {
                    ...
                    {
                        case EventDeviceViewerChanged.DeviceViewerChangeOrder.next:
                        default:
                            ...
                            break;
                        case EventDeviceViewerChanged.DeviceViewerChangeOrder.previous:
                            indiceSiguiente = indiceActual - 1;
                            if (!App.InRange(indiceSiguiente, 0, this.ListaDisplays.Count - 1))
                            {
        ...
        /// <param name="e"></param>
        public void OnEstadoVentanaCambiado(object sender, EventStateMaximized e)
        {
            try 
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public void OnVisorDispositivoCambiado(object sender, EventDeviceViewerChanged e)
        {
            try 
            {
