...
namespace Orbita.VAControl
{
	...
	public static class AppBD
	{
		...
		public static DataTable GetMaquinasEstados()
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("EST_GET_MAQUINAS_ESTADO", list);
		}
		...
		public static DataTable GetMaquinaEstados(string codMaquinaEstados)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("EST_GET_MAQUINA_ESTADO", list);
		}
		...
		public static DataTable GetEstados(string codMaquinaEstados)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("EST_GET_ESTADOS", list);
		}
		...
		public static DataTable GetTransiciones(string codMaquinaEstados)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("EST_GET_TRANSICIONES", list);
		}
		...
		public static DataTable GetEstado(string codMaquinaEstados, string codEstado)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("EST_GET_ESTADO", list);
		}
		...
		public static DataTable GetEstadoAsincrono(string codMaquinaEstados, string codEstado)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("EST_GET_ESTADO_THREAD", list);
		}
		...
		public static DataTable GetTransicion(string codMaquinaEstados, string codTransicion)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("EST_GET_TRANSICION", list);
		}
		...
		public static DataTable GetVariablesTransicion(string codMaquinaEstados, string codTransicion)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("EST_GET_VARIABLES_TRANSICION", list);
		}
		...
		public static DataTable GetVariables()
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("VAR_GET_VARIABLES", list);
		}
		...
		public static DataTable GetVariable(string codVariable)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("VAR_GET_VARIABLE", list);
		}
		...
		public static DataTable GetListaVariables()
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("VAR_GET_LISTA_VARIABLES", list);
		}
		...
		public static DataTable GetTiposVariables()
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("VAR_GET_TIPOS_VARIABLES", list);
		}
		...
		public static DataTable GetAliasVistaVariables(string codVista)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("VAR_GET_ALIAS_VISTA", list);
		}
		...
		public static DataTable GetClavesDeVista(string codVista)
		{
			...
			return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("VST_GET_VISTA_CLAVES", list);
		}
		...
		public static int AddTrazas(CXML datosTrazas)
		{
			ArrayList list = new ArrayList();

			list.Add(new SqlParameter("@DATOS_TRAZAS_ADD", (datosTrazas == null) ? null : datosTrazas.SW_XML.ToString()));

			return BaseDatosAlmacen.SQLServer.EjecutarProcedimientoAlmacenado("VAR_ADD_TRAZAS_XML", list);
		}
		...
		public static int AddVariable(string codigo, string nombre, string descripcion, bool habilitado, string grupo, bool trazabilidad, int tipo)
		{
			...
			return BaseDatosParam.SQLServer.EjecutarProcedimientoAlmacenado("VAR_ADD_LISTA_VARIABLES", list);
		}
		#endregion
		...
		public static int ModificaVariable(int id, string codigo, string nombre, string descripcion, bool habilitado, string grupo, bool trazabilidad, int tipo)
		{
			...
			return BaseDatosParam.SQLServer.EjecutarProcedimientoAlmacenado("VAR_MDF_LISTA_VARIABLES", list);
		}
		#endregion 
		...
		public static int EliminaVariable(int idVariable)
		{
			...
			return BaseDatosParam.SQLServer.EjecutarProcedimientoAlmacenado("VAR_DEL_LISTA_VARIABLES", list);
		}
		#endregion
	}
}
