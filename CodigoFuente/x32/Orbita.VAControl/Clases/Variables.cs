...
namespace Orbita.VAControl
{
    ...
    /// </summary>
    public static class VariableRuntime
    {
        #region Atributo(s)
        ...
        /// </summary>
        public static Dictionary<string, VariableItem> ListaVariables;

        /// <summary>
        /// Lista de todas las vistas de variables del sistema
        /// </summary>
        public static Dictionary<string, VistaVariable> Vistas;

        /// <summary>
        /// Variable que almacena la trazabilidad de las variables
        /// </summary>
        private static Trazabilidad Trazabilidad;
        ...
        public static void Constructor()
        {
            ...
            ListaVariables = new Dictionary<string, VariableItem>();
            Vistas = new Dictionary<string, VistaVariable>();
            Trazabilidad = new Trazabilidad();

            CadenciaMonitorizacion = SystemRuntime.Configuracion.CadenciaMonitorizacion;
            ...
            RemotingConfiguration.RegisterWellKnownServiceType(typeof(GetRemoteVariableCore), "Vars", WellKnownObjectMode.Singleton); //register remote object
            ...
            if (dtVar.Rows.Count > 0)
            {
                ...
                foreach (DataRow drVar in dtVar.Rows)
                {
                    ...
                    varItem = new VariableItem(codVariable);
            ...
            if (dtVista.Rows.Count > 0)
            {
                ...
                foreach (DataRow drVista in dtVista.Rows)
                {
                    ...
                    vista = new VistaVariable(codVista);
        ...
        {
            foreach (VariableItem varItem in ListaVariables.Values)
            {
                varItem.Inicializar();
            }
        ...
        /// <param name="codigo">Código de la variable</param>
        /// <returns>Devuelve verdadero si valor de la variable con el código correspondientes ha cambiado</returns>
        public static EnumTipoDato GetType(string codigo)
        {
        ...
        /// <param name="codigo">Código de la variable</param>
        /// <returns>Devuelve verdadero si valor de la variable con el código correspondientes ha cambiado</returns>
        public static EnumTipoDato GetType(string vista, string codigo)
        {
            VariableItem variable;
            if (TryGetVariable(vista, codigo, out variable))
            {
            ...
            return EnumTipoDato.SinDefinir;
        }
        ...
        public static VariableItem GetVariable(string codigo)
        {
        ...
        /// <param name="codigo">Código de la variable</param>
        /// <returns>variable</returns>
        public static VariableItem GetVariable(string vista, string codigo)
        {
            VariableItem variable;
            if (TryGetVariable(vista, codigo, out variable))
            {
        ...
        /// <param name="codigoModuloLlamada">Código identificativo del módulo que modifica a la variable</param>
        /// <param name="descripcionLlamada">Descripción de la modificación de la variable</param>
        public static void CrearSuscripcion(string codigo, string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegate delegadoSuscriptor)
        {
        ...
        /// <param name="codigoModuloLlamada">Código identificativo del módulo que modifica a la variable</param>
        /// <param name="descripcionLlamada">Descripción de la modificación de la variable</param>
        public static void CrearSuscripcion(string vista, string codigo, string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegate delegadoSuscriptor)
        {
            VariableItem variable;
            if (TryGetVariable(vista, codigo, out variable))
            {
        ...
        /// <param name="codigoModuloLlamada">Código identificativo del módulo que modifica a la variable</param>
        /// <param name="descripcionLlamada">Descripción de la modificación de la variable</param>
        public static void CrearSuscripcion(string codigo, string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegateAdvanced delegadoSuscriptor)
        {
            CrearSuscripcion(string.Empty, codigo, codigoModuloLlamada, descripcionLlamada, delegadoSuscriptor);
        }
        /// <summary>
        ...
        /// <param name="codigoModuloLlamada">Código identificativo del módulo que modifica a la variable</param>
        /// <param name="descripcionLlamada">Descripción de la modificación de la variable</param>
        public static void CrearSuscripcion(string vista, string codigo, string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegateAdvanced delegadoSuscriptor)
        {
            VariableItem variable;
            if (TryGetVariable(vista, codigo, out variable))
            {
        ...
        /// <param name="codigoModuloLlamada">Código identificativo del módulo que modifica a la variable</param>
        /// <param name="descripcionLlamada">Descripción de la modificación de la variable</param>
        public static void EliminarSuscripcion(string codigo, string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegate delegadoSuscriptor)
        {
        ...
        /// <param name="codigoModuloLlamada">Código identificativo del módulo que modifica a la variable</param>
        /// <param name="descripcionLlamada">Descripción de la modificación de la variable</param>
        public static void EliminarSuscripcion(string vista, string codigo, string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegate delegadoSuscriptor)
        {
            VariableItem variable;
            if (TryGetVariable(vista, codigo, out variable))
            {
        ...
        /// <param name="codigoModuloLlamada">Código identificativo del módulo que modifica a la variable</param>
        /// <param name="descripcionLlamada">Descripción de la modificación de la variable</param>
        public static void EliminarSuscripcion(string codigo, string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegateAdvanced delegadoSuscriptor)
        {
            EliminarSuscripcion(string.Empty, codigo, codigoModuloLlamada, descripcionLlamada, delegadoSuscriptor);
        }
        /// <summary>
        ...
        /// <param name="codigoModuloLlamada">Código identificativo del módulo que modifica a la variable</param>
        /// <param name="descripcionLlamada">Descripción de la modificación de la variable</param>
        public static void EliminarSuscripcion(string vista, string codigo, string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegateAdvanced delegadoSuscriptor)
        {
            VariableItem variable;
            if (TryGetVariable(vista, codigo, out variable))
            {
        ...
        internal static void NuevaTraza(Traza traza)
        {
        ...
        private static bool TryGetVariable(string codVista, string codAlias, out VariableItem variableItem)
        {
            ...
            return ListaVariables.TryGetValue(alias, out variableItem);
        }
        #endregion
    }
    ...
    public class VistaVariable
    {
        ...
        public VistaVariable(string codVista)
        {
    ...
    public class VariableItem
    {
        ...
        /// </summary>
        private VariableBroadcastEventWraper EventWrapper;
        #endregion
        ...
        /// Constructor de la clase
        /// </summary>
        public VariableItem(string codigo)
        {
            ...
            if (dtVariable.Rows.Count == 1)
            {
                ...
                EnumTipoDato tipo = (EnumTipoDato)App.EvaluaNumero(dtVariable.Rows[0]["IdTipoVariable"], 0, 99, 0);
                ...
                if (this.Remoto) // Cliente Remoting
                {
                    ...
                    GetRemoteVariableCore getRemoteVariableCore = (GetRemoteVariableCore)Activator.GetObject(typeof(GetRemoteVariableCore), direccion);
                    this.VariableCore = getRemoteVariableCore.GetVariableCore(this.CodigoRemoto);

                    // Eventos
                    this.EventWrapper = new VariableBroadcastEventWraper();
        ...
        [EnvironmentPermissionAttribute(SecurityAction.Demand, Unrestricted = true)]
        public void CrearSuscripcion(string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegate delegadoSuscriptor)
        {
            if (VariableRuntime.Iniciado)
            {
        ...
        /// <param name="delegadoSuscriptor">Delegado que queremos suscribir</param>
        [EnvironmentPermissionAttribute(SecurityAction.Demand, Unrestricted = true)]
        public void CrearSuscripcion(string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegateAdvanced delegadoSuscriptor)
        {
            if (VariableRuntime.Iniciado)
            {
        ...
        [EnvironmentPermissionAttribute(SecurityAction.Demand, Unrestricted = true)]
        public void EliminarSuscripcion(string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegate delegadoSuscriptor)
        {
            if (VariableRuntime.Iniciado)
            {
                this.CambioValor -= delegadoSuscriptor;
        ...
        /// <param name="delegadoSuscriptor">Delegado que queremos desuscribir</param>
        [EnvironmentPermissionAttribute(SecurityAction.Demand, Unrestricted = true)]
        public void EliminarSuscripcion(string codigoModuloLlamada, string descripcionLlamada, CambioValorDelegateAdvanced delegadoSuscriptor)
        {
            if (VariableRuntime.Iniciado)
            {
                this.CambioValorAvanzado -= delegadoSuscriptor;
        ...
        /// </summary>
        private event CambioValorDelegate CambioValor = null;

        /// <summary>
        /// Implementación del delegado que se activa cuando cambia el valor de la variable
        /// </summary>
        private event CambioValorDelegateAdvanced CambioValorAvanzado = null;
        ...
        /// </summary>
        [EnvironmentPermissionAttribute(SecurityAction.Demand, Unrestricted = true)]
        private void EjecutaEventos(CambioValorEventArgs e)
        {
            try
            {
                if (!ThreadRuntime.EjecucionEnTrheadPrincipal())
                {
                    ThreadRuntime.SincronizarConThreadPrincipal(new CambioValorEvent(EjecutaEventos), new object[] { e });
                    return;
                }
            ...
            {
                LogsRuntime.Error(ModulosControl.Variables, "CambioValor", exception);
            }
        }
    ...
    /// </summary>
    [Serializable]
    public class VariableCore : MarshalByRefObject
    {
        #region Atributo(s)
        /// <summary>
        ...
        /// Constructor de la clase
        /// </summary>
        public VariableCore(string codigo, bool habilitado, EnumTipoDato tipo, bool guardarTrazabilidad)
        {
            // Inicialiamos los valores
            this._Bloqueo = false;
            ...
            this.Valor = Orbita.VAComun.TipoDato.DevaultValue(this.Tipo);
        }
        ...
        private void EjecutaDelegado()
        {
            ...
            if (this._Habilitado)
            {
                ...
                if (this.CambioValor != null)
                {
                    try
                    {
                            this.CambioValor(new CambioValorEventArgs(this.Codigo, this.Valor));
                    }
                    catch (Exception exception)
                    {
                        LogsRuntime.Error(ModulosControl.Variables, "CambioValor", exception);
        ...
        private void NuevaTraza(string codigoModuloLlamada, string descripcionLlamada, TipoTraza tipoTraza)
        {
            ...
            {
                Traza trazaTrazabilidad = new Traza(this.Codigo, this.Valor, tipoTraza, codigoModuloLlamada, descripcionLlamada);
                VariableRuntime.NuevaTraza(trazaTrazabilidad);
            }
        }
        ...
        public void SetValor(object valor, string codigoModuloLlamada, string descripcionLlamada)
        {
            if ((this._Habilitado) && (this.Valor != valor) && (!this._Bloqueo) && (!this._Inhibido))
            {
                ...
                LogsRuntime.Debug(ModulosControl.Variables, "SetValor", "La variable " + this.Codigo + " cambia su valor a " + App.ToString(valor));
        ...
        public void SetValorRetrasado(object valor, TimeSpan retraso, string codigoModuloLlamada, string descripcionLlamada)
        {
            if ((this._Habilitado) && (this.Valor != valor) && (!this._Bloqueo) && (!this._Inhibido))
            {
                ...
                Secuencia secuencia = new Secuencia(this.Codigo + "-Retrasado", System.Threading.ThreadPriority.BelowNormal, 1);
                secuencia.Add(new SecuenciaItemValor(this.Codigo, valor, retraso));
                secuencia.Start();
            }
        }
        ...
        public void ForzarValor(object valor, string codigoModuloLlamada, string descripcionLlamada)
        {
            if ((this._Habilitado) && (this.Valor != valor) && (this._Bloqueo))
            {
                ...
                LogsRuntime.Info(ModulosControl.Variables, "SetValor", "La variable " + this.Codigo + " cambia su valor a " + App.ToString(valor));
        ...
        public void Disparo(string codigoModuloLlamada, string descripcionLlamada)
        {
            if (this._Habilitado)
            {
                ...
                LogsRuntime.Debug(ModulosControl.Variables, "SetValor", "La variable " + this.Codigo + " realiza un disparo");
            ...
            while (true)
            {
                try
                {
                    lock (this)
                    {
                        ...
                        {
                            this.CambioValorRemoto(new CambioValorEventArgs(this.Codigo, this.Valor));
                        }
                    }
                }
                catch
    ...
    /// </summary>
    [Serializable]
    public class VariableBroadcastEventWraper : MarshalByRefObject
    {
        #region Evento(s)
        /// <summary>
        ...
        [OneWay]
        [EnvironmentPermissionAttribute(SecurityAction.Demand, Unrestricted = true)]
        public void OnCambioValor(CambioValorEventArgs e)
        {
            try
            {
                if (CambioValor != null)
    ...
    /// </summary>
    [Serializable]
    public class GetRemoteVariableCore : MarshalByRefObject
    {
        #region Método(s) público(s)
        /// <summary>
        ...
        {
            VariableItem variable;
            if (VariableRuntime.ListaVariables.TryGetValue(codigo, out variable))
            {
    ...
    /// <param name="e"></param>
    public delegate void CambioValorEvent(CambioValorEventArgs e);

    /// <summary>
    /// Argumentos del evento
    /// </summary>
    [Serializable]
    public class CambioValorEventArgs
    {
        #region Propiedad(es)
        /// <summary>
        /// Código identificativo de la variable
        ...
        public CambioValorEventArgs(string codigo, object valor)
        {
            this._Codigo = codigo;
            this._Valor = valor;
        }
    ...
    /// </summary>
    public delegate void CambioValorDelegate();

    /// <summary>
    /// Declaración del delegado que se activa cuando cambia el valor de una variable
    /// </summary>
    public delegate void CambioValorDelegateAdvanced(string codigo, object valor);
    ...
    /// </summary>
    public class Secuencia : List<SecuenciaItemBase>
    {
        #region Atributo(s)
        /// <summary>
        ...
        /// Constructor de la clase
        /// </summary>
        public Secuencia(string codigo, ThreadPriority threadPriority, int repeticiones)
            : base()
        {
            this.Codigo = codigo;
        ...
        /// </summary>
        private void ThreadRun(out bool finalize)
        {
            finalize = true;
            try
            {
                ...
                if (this.Count > 0)
                {
                    if ((this.ContRepeticiones < this.Repeticiones) || (this.Repeticiones == -1))
                    {
                        ...
                        {
                            SecuenciaItemBase secuenciaItem = this[this.ContSecuencias];
                            TimeSpan momentoEjecucion = secuenciaItem.MomentoEjecucion;
                            if (this.DuracionEjecucion.Elapsed >= momentoEjecucion)
                            {
                                ThreadRuntime.SincronizarConThreadPrincipal(secuenciaItem.EjecutaElementoSecuencia, new object[] { });
                                this.ContSecuencias++;
                            }
                        }
                        else
            ...
            {
                LogsRuntime.Error(ModulosControl.Variables, "Secuencia", exception);
            }
        }
        ...
        public void Start()
        {
            ...
            this.ThreadEjecucion = new ThreadOrbita("Secuencia_" + this.Codigo, 10, this.ThreadPriority);
    ...
    /// </summary>
    public class SecuenciaItemValor : SecuenciaItemBase
    {
        #region Atributo(s)
        /// <summary>
        ...
        public SecuenciaItemValor(string codVariable, object valor, TimeSpan momentoEjecucion)
        ...
        public SecuenciaItemValor(string codVariable, object valor, TimeSpan momentoMinimoEjecucionAleatorio, TimeSpan momentoMaximoEjecucionAleatorio)
        ...
        {
            VariableRuntime.SetValue(this.CodVariable, this.Valor, "Secuencia", this.CodVariable);
        }
        #endregion
    }
    ...
    /// Clase base para los elementos de la secuencia
    /// </summary>
    public class SecuenciaItemComando : SecuenciaItemBase
    {
        #region Constructor
        /// <summary>
        /// Constructor de la clase
        ...
        /// <param name="valor">Valor a establecer en la variable</param>
        /// <param name="momentoEjecucion"></param>
        public SecuenciaItemComando(string codVariable, TimeSpan momentoEjecucion)
            : base(codVariable, momentoEjecucion)
        {
        }
        /// <summary>
        ...
        /// <param name="momentoMinimoEjecucionAleatoria">Momento mínimo de la ejecución aleatoria</param>
        /// <param name="momentoMaximoEjecucionAleatoria">Momento máximio de la ejecución aleatoria</param>
        public SecuenciaItemComando(string codVariable, TimeSpan momentoMinimoEjecucionAleatorio, TimeSpan momentoMaximoEjecucionAleatorio)
            : base(codVariable, momentoMinimoEjecucionAleatorio, momentoMaximoEjecucionAleatorio)
        {
        }
        #endregion
        ...
        protected override void OnEjecuta()
        {
            VariableRuntime.Dispara(this.CodVariable, "Secuencia", this.CodVariable);
        }
        #endregion
    }
    ...
    /// Clase base para los elementos de la secuencia
    /// </summary>
    public class SecuenciaItemBase
    {
        #region Atributo(s)
        /// <summary>
        ...
        /// </summary>
        /// <param name="momentoEjecucion"></param>
        public SecuenciaItemBase(string codVariable, TimeSpan momentoEjecucion)
        {
        ...
        /// <param name="momentoMinimoEjecucionAleatoria">Momento mínimo de la ejecución aleatoria</param>
        /// <param name="momentoMaximoEjecucionAleatoria">Momento máximio de la ejecución aleatoria</param>
        public SecuenciaItemBase(string codVariable, TimeSpan momentoMinimoEjecucionAleatorio, TimeSpan momentoMaximoEjecucionAleatorio)
        {
            this.CodVariable = codVariable;
    ...
    internal class Trazabilidad
    {
        ...
        /// Cola de las trazas
        /// </summary>
        private Queue<Traza> ColaTrazas;
        /// <summary>
        ...
        public Trazabilidad()
        {
            this.ColaTrazas = new Queue<Traza>();
        }
        #endregion
        ...
        public void Inicializar()
        {
            ...
            this.TimerEjecucion.Interval = Convert.ToInt32(Math.Round(VariableRuntime.TiempoPermanenciaTrazasEnMemoria.TotalMilliseconds));
        ...
        /// </summary>
        /// <param name="traza"></param>
        public void NuevaTraza(Traza traza)
        {
            ...
            LogsRuntime.Debug(ModulosControl.Variables, traza.CodVariable, info);
        }
        ...
        private Queue<Traza> ObtenerTrazasAGuardar()
        {
            Queue<Traza> colaTrazas = new Queue<Traza>();
            ...
            while (!salirBucle)
            {
                ...
                if (!salirBucle)
                {
                    Traza traza = this.ColaTrazas.Peek();

                    salirBucle = (traza.Fecha > DateTime.Now - VariableRuntime.TiempoPermanenciaTrazasEnMemoria);

                    if (!salirBucle)
                    {
                        VariableItem variable = VariableRuntime.GetVariable(traza.CodVariable);
        ...
        private CXML ConvertirTrazasXML(Queue<Traza> colaTrazas)
        {
            CXML oXML = new CXML();
            while (colaTrazas.Count > 0)
            {
                Traza traza = colaTrazas.Dequeue();
        ...
        public void EventoTimerEjecucion(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Queue<Traza> colaTrazas = this.ObtenerTrazasAGuardar();

                    if (colaTrazas.Count > 0)
                    {
                        CXML oXML = this.ConvertirTrazasXML(colaTrazas);
            ...
            {
                LogsRuntime.Error(ModulosControl.Variables, "Trazabilidad", exception);
            }
        }
    ...
    internal struct Traza
    {
        ...
        #region Constructor
        public Traza(string codVariable, object valor, TipoTraza tipoTraza, string codModuloLlamada, string descripcionLlamada)
        {
            this.CodVariable = codVariable;
            this.Valor = valor;
