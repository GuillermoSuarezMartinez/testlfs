...
namespace Orbita.VAControl
{
    ...
    /// </summary>
    public partial class CtrlStateMachineDisplay : UserControl
    {
        #region Atributo(s)
        ...
        /// </summary>
        private MaquinaEstadosVisual MaquinaEstadosVisual;
        ...
        /// </summary>
        public CtrlStateMachineDisplay()
        {
            InitializeComponent();
        } 
        ...
        public void Inicializar(string codigo, ModoAperturaFormulario modoAperturaFormulario, bool online)
        {
            ...
            this.timerRefresco.Interval = Convert.ToInt32(VariableRuntime.CadenciaMonitorizacion.TotalMilliseconds);

            // Inicializar variables
            this.MaquinaEstadosVisual = new MaquinaEstadosVisual(codigo, online);
            ...
            StateMachineRuntime.CrearSuscripcionMensajes(this.Codigo, this.ProcMensajeMaquinaEstados);

            // Nos suscribimos a los cambios de la variable de estado actual
            StateMachineRuntime.EliminarSuscripcionCambioEstado(this.Codigo, this.RefrescarEstadoActual);
            if (this.ModoAperturaFormulario == ModoAperturaFormulario.Monitorizacion)
            {
                StateMachineRuntime.CrearSuscripcionCambioEstado(this.Codigo, this.RefrescarEstadoActual);
        ...
        public void Finalizar()
        {
            ...
            StateMachineRuntime.EliminarSuscripcionCambioEstado(this.Codigo, this.RefrescarEstadoActual);
            StateMachineRuntime.EliminarSuscripcionMensajes(this.Codigo, this.ProcMensajeMaquinaEstados);
        }
        ...
        private void CtrlStateMachineDisplay_Load(object sender, EventArgs e)
        {
            if (!this.DesignMode)
            {
                ...
                {
                    LogsRuntime.Error(ModulosControl.MonitorizacionMaquinasEstado, this.Name, exception);
                }
            }
        }
        ...
        private void RefrescarEstadoActual()
        {
            try
            {
                string codEstadoActual = StateMachineRuntime.GetEstadoActual(this.Codigo);
        ...
        private void RefrescarEstadoActual(string codEstado)
        {
            try
            {
                ...
                foreach (EstadoVisual estado in this.MaquinaEstadosVisual.ListaEstados)
                {
    ...
    /// </summary>
    internal class MaquinaEstadosVisual
    {
        #region Atributo(s)
        /// <summary>
        /// Código de la clase
        ...
        /// </summary>
        public List<EstadoVisual> ListaEstados;

        /// <summary>
        /// Lista de transiciones visuales
        /// </summary>
        public List<TransicionVisual> ListaTransiciones;
        ...
        /// </summary>
        public MaquinaEstadosBase MaquinaEstadosAsociada;
        #endregion

        #region Constructor(es)

        public MaquinaEstadosVisual(string codigo, bool online)
        {
            this.ListaEstados = new List<EstadoVisual>();
            this.ListaTransiciones = new List<TransicionVisual>();
            ...
            try
            {
                ...
                if (online)
                {
                    this.MaquinaEstadosAsociada = StateMachineRuntime.GetMaquinaEstados(this.Codigo);
                }
                ...
                if (dtEstados.Rows.Count > 0)
                {
                    foreach (DataRow dr in dtEstados.Rows)
                    {
                        ...
                        EstadoBase estadoAsociado = null;
                        if (online)
                        {
                            estadoAsociado = this.MaquinaEstadosAsociada.GetEstado(codEstado);
                        }

                        this.ListaEstados.Add(new EstadoVisual(this.Codigo, codEstado, this.Online, estadoAsociado));
                    }
                }
                ...
                if (dtTransiciones.Rows.Count > 0)
                {
                    ...
                    { 
                        ...
                        TransicionBase transcionAsociada = null;
                        if (online)
                        {
                            transcionAsociada = this.MaquinaEstadosAsociada.GetTransicion(codTransicion);
                        }

                        this.ListaTransiciones.Add(new TransicionVisual(this.Codigo, codTransicion, this.Online, transcionAsociada, this.ListaEstados));
                    }
                }
            }
            catch (Exception exception)
            {
                LogsRuntime.Error(ModulosControl.MonitorizacionMaquinasEstado, this.Codigo, exception);
            }
        }
        ...
        {
            foreach (EstadoVisual estado in this.ListaEstados)
            {
                estado.Pinta(g);
            } 
            foreach (TransicionVisual transicion in this.ListaTransiciones)
            {
                transicion.Pinta(g);
            }
        }
    ...
    internal class EstadoVisual
    {
        ...
        /// Estado asociado
        /// </summary>
        public EstadoBase EstadoAsociado;
        ...
        public EstadoVisual(string codigoMaquinaEstados, string codigo, bool online, EstadoBase estadoAsociado)
        {
            ...
            if (dtEstado.Rows.Count == 1)
            {
                ...
                if (App.IsNumericInt(dtEstado.Rows[0]["PosX"]))
                {
                    this.Localizacion.X = (int)dtEstado.Rows[0]["PosX"];
                }
                if (App.IsNumericInt(dtEstado.Rows[0]["PosY"]))
                {
    ...
    /// </summary>
    internal class TransicionVisual
    {
        #region Atributo(s)
        ...
        /// Transicion asociada
        /// </summary>
        public TransicionBase TransicionAsociada;

        /// <summary>
        /// Estado origen
        /// </summary>
        public EstadoVisual EstadoOrigen;

        /// <summary>
        /// Estado origen
        /// </summary>
        public EstadoVisual EstadoDestino;
        ...
        /// </summary>
        /// <param name="_estadoAsociado">Estado asociado a la visualización</param>
        public TransicionVisual(string codigoMaquinaEstados, string codigo, bool online, TransicionBase transicionAsociada, List<EstadoVisual> listaEstados)
        {
            this.CodigoMaquinaEstados = codigoMaquinaEstados;
            this.Codigo = codigo;
            this.Online = online;
            ...
            // Cargamos valores de la base de datos
            DataTable dtTransicion = AppBD.GetTransicion(this.CodigoMaquinaEstados, this.Codigo);
            if (dtTransicion.Rows.Count == 1)
            {
                this.Nombre = dtTransicion.Rows[0]["NombreTransicion"].ToString();
                
                if (App.IsNumericInt(dtTransicion.Rows[0]["PosicionFlechaEstadoOrigen"]) && 
                   (App.IsNumericInt(dtTransicion.Rows[0]["PosicionFlechaEstadoDestino"])))
                {
                    // Se busca la posición origen
                    string codigoEstadoOrigen = dtTransicion.Rows[0]["CodigoEstadoOrigen"].ToString();
                    this.EstadoOrigen = listaEstados.Find(delegate(EstadoVisual e) { return e.Codigo == codigoEstadoOrigen; });
                    ...
                    this.EstadoDestino = listaEstados.Find(delegate(EstadoVisual e) { return e.Codigo == codigoEstadoDestino; });
        ...
        /// <returns></returns>
        private Point CalcularPosicionRelativaAEstado(PosicionFlecha posicionFlecha, EstadoVisual estadoAsociado)
        {
        ...
        public void Inicializar()
        {
            if ((this.EstadoOrigen == null) && this.EstadoDestino is EstadoVisual) // Transición universal
            {
                // Creamos las variables de visualización
            ...
            else if ((this.EstadoOrigen is EstadoVisual) && (this.EstadoDestino is EstadoVisual)) // Transición de un estado a otro
            {
