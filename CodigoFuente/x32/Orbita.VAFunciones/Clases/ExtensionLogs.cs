...
namespace Orbita.VAFunciones
{
    ...
    public class ModulosFunciones: ModulosSistema
    {
        ...
        /// <summary>
        /// Módulo de OCR de contenedores
        /// </summary>
        public static EnumModulosSistema OCRContainer = new EnumModulosSistema("OCRContainer", "Módulo de lectura de las matrículas de los contenedoress", 303);
        /// <summary>
