...
namespace Orbita.VAFunciones
{
    ...
    public static class VisionRuntime
    {
        ...
        /// </summary>
        private static List<VisionFunctionBase> ListaFuncionesVision;
        ...
        public static void Constructor()
        {
            ...
            ListaFuncionesVision = new List<VisionFunctionBase>();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    {
                        VisionFunctionBase funcionVision = (VisionFunctionBase)objetoImplementado;
        ...
        public static void Destructor()
        {
            ...
            LPRRuntime.FinDemandaUso();

            // Se elimina la demanda del uso de OCR
            OCRRuntime.FinDemandaUso();
        }
        ...
        {
            foreach (VisionFunctionBase visionFunction in ListaFuncionesVision)
            {
        ...
        public static bool SetEntrada(string codFuncionVision, string codParametro, object valor, EnumTipoDato tipoVariable)
        {
            foreach (VisionFunctionBase visionFunction in ListaFuncionesVision)
            {
                if (visionFunction.Codigo == codFuncionVision)
        ...
        /// <param name="tipoVariable">Tipo del parámetro</param>
        /// <returns>Verdadero si la función se ha ejecutado correctamente</returns>
        public static bool GetSalida(string codFuncionVision, string codParametro, out object valor, EnumTipoDato tipoVariable)
        {
            valor = null;
            foreach (VisionFunctionBase visionFunction in ListaFuncionesVision)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static VisionFunctionBase GetFuncionVision(Claves claves)
        {
            VisionFunctionBase resultado = null;

            foreach (VisionFunctionBase funcionVision in ListaFuncionesVision)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetCodigoFuncionVision(Claves claves)
        {
    ...
    /// </summary>
    public class VisionFunctionBase
    {
        #region Atributo(s)
        /// <summary>
        /// Lista de entradas de la funcion
        /// </summary>
        public List<ParametroFuncionVision> ListaParametrosEntrada;

        /// <summary>
        /// Lista de salidas de la función
        /// </summary>
        public List<ParametroFuncionVision> ListaParametrosSalida;
        ...
        /// </summary>
        public VisionFunctionBase(string codFuncionVision)
        {
            // Inicialiamos los valores
            this._Codigo = codFuncionVision;
            this.ListaParametrosEntrada = new List<ParametroFuncionVision>();
            this.ListaParametrosSalida = new List<ParametroFuncionVision>();
            this._Valido = false;
            ...
            if (dtFuncionVision.Rows.Count == 1)
            {
                ...
                this._TipoEjecucionFuncionVision = (TipoEjecucionFuncionVision)App.EnumParse(typeof(TipoEjecucionFuncionVision), dtFuncionVision.Rows[0]["TipoEjecucion"].ToString(), TipoEjecucionFuncionVision.EjecucionSincrona);
                ...
                if (dtParametrosEntrada.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dtParametrosEntrada.Rows)
                    {
                        ...
                        {
                            ParametroFuncionVision parametro = new ParametroFuncionVision(this._Codigo, (string)codParametroEntradaAux);
                ...
                if (dtParametrosSalida.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dtParametrosSalida.Rows)
                    {
                        ...
                        {
                            ParametroFuncionVision parametro = new ParametroFuncionVision(this._Codigo, (string)codParametroSalidaAux);
                ...
                CronometroRuntime.NuevoCronometro(this._Codigo, "Ejecución función " + this.Nombre, "Ejecución de la función de visión " + this.Nombre);
            }
        }
        ...
        internal void IniciarEjecucionSincrona()
        {
            if (this._Valido)
            {
                ...
                // Guardamos la traza
                LogsRuntime.Info(ModulosFunciones.Vision, this._Codigo, "Inicio de la ejecución síncrona de la función " + this._Codigo);

                this.EjecucionTerminada = false;

                // Llamada a la variable que indica el estado de ejecución de la función
                VariableRuntime.SetValue(this._CodVariableEnEjecucion, true, "Vision", this.Codigo);
        ...
        internal void IniciarEjecucionAsincrona()
        {
            if (this._Valido)
            {
                ...
                // Guardamos la traza
                LogsRuntime.Info(ModulosFunciones.Vision, this._Codigo, "Inicio de la ejecución asíncrona de la función " + this._Codigo);
        ...
        public bool GetSalidas(out Dictionary<string, object> listaSalidas)
        {
            ...
            foreach (ParametroFuncionVision parametro in this.ListaParametrosSalida)
            {
        ...
        {
            object valorEntrada;
            foreach (ParametroFuncionVision parametro in this.ListaParametrosEntrada)
            {
                switch (parametro.OrigenValorParametro)
                {
                    case OrigenValorParametro.ValorVariable:
                        valorEntrada = VariableRuntime.GetValue(parametro.CodVariable);
            ...
            foreach (ParametroFuncionVision parametro in this.ListaParametrosSalida)
            {
                switch (parametro.OrigenValorParametro)
                {
                    case OrigenValorParametro.ValorVariable:
                        if (this.GetSalida(parametro.Codigo, out valorSalida, parametro.Tipo))
                        {
                            VariableRuntime.SetValue(parametro.CodVariable, valorSalida, "VisionFunction", this.Codigo);
                        }
                        break;
                }
            }
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public virtual bool SetEntrada(string codigo, object valor, EnumTipoDato tipoVariable)
        {
            return false;
        }
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public virtual bool GetSalida(string codigo, out object valor, EnumTipoDato tipoVariable)
        {
            valor = null;
            return false;
        }
        ...
        protected void FuncionEjecutada()
        {
            try
            {
                ...
                // Guardamos la traza
                LogsRuntime.Info(ModulosFunciones.Vision, this._Codigo, "Fin de la ejecución de la función " + this._Codigo + ". Duración: " + CronometroRuntime.DuracionUltimaEjecucion(this._Codigo).ToString());

                // Llamada a la variable que indica el estado de ejecución de la función
                VariableRuntime.SetValue(this._CodVariableEnEjecucion, false, "Vision", this.Codigo);

                this.EjecucionTerminada = true;
            }
            catch (Exception exception)
            {
                LogsRuntime.Error(ModulosFunciones.Vision, this._Codigo, exception);
            }
        }
        #endregion
    }
    ...
    /// Clase base para todas las funciones de visión
    /// </summary>
    public class VisionFunctionQueue : VisionFunctionBase
    {
        #region Atributo(s)
        /// <summary>
        ...
        /// Contructor de la clase
        /// </summary>
        public VisionFunctionQueue(string codFuncionVision)
        ...
        internal void IniciarEjecucionEncolada()
        {
            ...
            {
                // Cronometramos la duración de la ejecución
                CronometroRuntime.Start(this.Codigo);

                // Guardamos la traza
                LogsRuntime.Info(ModulosFunciones.Vision, this.Codigo, "Inicio de la ejecución encolada de la función " + this.Codigo);

                this.EjecucionTerminada = false;

                // Llamada a la variable que indica el estado de ejecución de la función
                VariableRuntime.SetValue(this.CodVariableEnEjecucion, true, "Vision", this.Codigo);
        ...
        internal virtual void AñadirResultadoParcial(object sender, EventArgsResultadoParcial e)
        {
            ...
            {
                LogsRuntime.Error(ModulosFunciones.Vision, this.Codigo, exception);
            }
        }
    ...
    /// </summary>
    public class ParametroFuncionVision
    {
        #region Propiedad(es)
        /// <summary>
        ...
        /// </summary>
        public ParametroFuncionVision(string codFuncionVision, string codParametroFuncionVision)
        {
            // Inicialiamos los valores
            ...
            if (dtParametro.Rows.Count == 1)
            {
                ...
                this._OrigenValorParametro = (OrigenValorParametro)App.EnumParse(typeof(OrigenValorParametro), dtParametro.Rows[0]["OrigenValorParametro"].ToString(), OrigenValorParametro.ValorPorCodigo);
                this._Tipo = (EnumTipoDato)App.EvaluaNumero(dtParametro.Rows[0]["IdTipoParametroFuncionVision"], 0, 99, 0);
    ...
    public class InfoInspeccion<TImagen, TInfo, TParametros, TResultados>
        where TImagen: OrbitaImage, new()
        where TInfo : new()
        ...
        where TResultados : new()
    {
        ...
        /// Constructor de la clase
        /// </summary>
        public InfoInspeccion(TImagen imagen, TInfo info, TParametros parametros, TResultados resultados)
        {
            this.Imagen = imagen;
            this.Info = info;
