    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            if (args.Length >= 5)
            {
                ...
                SystemRuntime.Constructor(new Sistema(args[1]));
                SystemRuntime.IniciarSistema();

                // Generación de la unidad
                GeneradorAccesoRapido generador = new GeneradorAccesoRapido();
        ...
        /// <returns></returns>
        private static bool GenerarMaquinaEstados(GeneradorAccesoRapido generador, string claseImplementadora, string descripcionMaquinaEstados, out CodeTypeDeclaration claseMaquinaEstados)
        {
            // Generación de la clase parcial de la máquina de estados
        ...
        /// <returns></returns>
        private static bool GenerarEscenario(GeneradorAccesoRapido generador, string claseImplementadora, string descripcionEscenario, out CodeTypeDeclaration claseEscenario)
        {
        ...
        /// <param name="claseEscenario"></param>
        private static void GenerarVariables(GeneradorAccesoRapido generador, string codVista, CodeTypeDeclaration claseEscenario)
        {
        ...
        /// <param name="codVista"></param>
        /// <param name="claseEscenario"></param>
        private static void GenerarHardware(GeneradorAccesoRapido generador, string codVista, CodeTypeDeclaration claseEscenario)
        {
        ...
        private static bool GenerarEstados(GeneradorAccesoRapido generador, string codMaquinaEstados, string claseImplementadoraEscenarioAsociado)
        {
            // Lectura de la base de datos
            ...
            foreach (DataRow drEstado in dtEstados.Rows)
            {
                ...
                TipoEstado tipoEstado = (TipoEstado)App.EnumParse(typeof(TipoEstado), drEstado["Tipo"].ToString(), TipoEstado.EstadoSimple);
                ...
                generador.GenerarConstructor(claseEstado, "Constructor de la clase", MemberAttributes.Public,
                    new CodeParameterDeclarationExpression[] 
                        { new CodeParameterDeclarationExpression(typeof(string), "codigoMaquinaEstados"),
                          ...
                          new CodeParameterDeclarationExpression(typeof(Escenario), "escenario")
                        },
                    new CodeExpression[] 
        ...
        /// <param name="generador"></param>
        /// <param name="codMaquinaEstados"></param>
        private static bool GenerarTransiciones(GeneradorAccesoRapido generador, string codMaquinaEstados, string claseImplementadoraEscenarioAsociado, out CodeTypeDeclaration ultimaTransicion)
        {
            ...
            foreach (DataRow drTransicion in dtTransiciones.Rows)
            {
                ...
                TipoTransicion tipoTransicion = (TipoTransicion)App.EnumParse(typeof(TipoTransicion), drTransicion["Tipo"].ToString(), TipoTransicion.TransicionSimple);
