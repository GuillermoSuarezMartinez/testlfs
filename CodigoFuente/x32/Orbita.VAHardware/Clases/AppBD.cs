...
namespace Orbita.VAHardware
{
    ...
    public static class AppBD
    {
        ...
        {
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("CAM_GET_CAMARAS");
        }
        /// <summary>
        ...
        public static DataTable GetCamara(string codCamara)
        {
            ...
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("CAM_GET_CAMARA", list);
        }
        ...
        {
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("IO_GET_TARJETAS");
        }
        /// <summary>
        ...
        public static DataTable GetTerminalesIO(string codTarjetaIO)
        {
            ...
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("IO_GET_TERMINALES", list);
        }
        /// <summary>
        ...
        public static DataTable GetTarjetaIO(string codTarjetaIO)
        {
            ...
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("IO_GET_TARJETA", list);
        }
        ...
        public static DataTable GetTerminalIO(string codTarjetaIO, string codTerminalIO)
        {
            ...
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("IO_GET_TERMINAL", list);
        }
        ...
        public static DataTable GetAliasVistaHardware(string codVista)
        {
            ...
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("HWR_GET_ALIAS_VISTA", list);
        }
        ...
        public static DataTable GetTerminalesIO_EscrituraSCED(string codTarjetaIO, string codTerminalIOEscritura)
        {
            ...
            return BaseDatosParam.SQLServer.SeleccionProcedimientoAlmacenado("IO_GET_SCED_TERMINALES_ESCRITURA", list);
        }
        #endregion
