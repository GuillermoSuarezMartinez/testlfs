...
namespace Orbita.VAHardware
{
    ...
    public class VisionProImage : OrbitaImage, ICloneable
    {
        ...
        {
            VisionProImage imagenResultado = new VisionProImage();
            if (this.Image != null)
            {
                try
                {
                ...
                {
                    LogsRuntime.Error(ModulosHardware.ImagenGraficosVPro, "VisionProImage_Clone", exception);
                }
            }
        ...
        public override bool Guardar(string ruta)
        {
            try
            {
                if (base.Guardar(ruta))
                {
                    ...
                    try
                    {
                        VisionProImageExtras extras = new VisionProImageExtras(this.Image.PixelFromRootTransform, this.Image.CoordinateSpaceTree);
                        formateador.Serialize(stream, extras);
                    }
                    catch (Exception exception)
                    {
                        LogsRuntime.Error(ModulosHardware.ImagenGraficosVPro, "VisionProImage", exception);
                    }
                    stream.Close();
        ...
        public override bool Cargar(string ruta)
        {
            try
            {
                if (base.Cargar(ruta))
                {
                    ...
                    {
                        VisionProImageExtras extras = null;
                        Stream stream = new FileStream(rutaCoordXYZ, FileMode.Open, FileAccess.Read, FileShare.Read);
                        BinaryFormatter formateador = new BinaryFormatter();
                        try
                        {
                            extras = (VisionProImageExtras)formateador.Deserialize(stream);
                        }
                        catch (Exception exception)
                        {
                            LogsRuntime.Error(ModulosHardware.ImagenGraficosVPro, "VisionProImage", exception);
        ...
        public override OrbitaImage ConvertFromBitmap(Bitmap imagenBitmap)
        {
            ...
            this.Image = cogImage;
            return new VisionProImage(cogImage);
        }
        ...
        {
            return new VisionProImage(this.Image.ScaleImage(ancho, alto));
        }
        ...
        public virtual byte[] ToArray(ImageFormat formato, double escalado)
        {
            ...
            if (this.Image is ICogImage)
            {
                try
                {
                    ...
                    VisionProImage imgAux = (VisionProImage)this.EscalarImagen(this, escalado);
        ...
        /// </summary>
        /// <returns></returns>
        public virtual OrbitaImage FromArray(byte[] arrayValue)
        {
            VisionProImage resultado = null;
            ...
            if (arrayValue.Length > 0)
            {
                try
                {
                    ...
                    resultado = new VisionProImage();
                    resultado = (VisionProImage)resultado.ConvertFromBitmap(bmp);
                }
                catch
                {
                    resultado = null;
    ...
    /// </summary>
    [Serializable]
    public class VisionProGrafico : OrbitaGrafico, IDisposable, ICloneable
    {
        #region Atributo(s)
        /// <summary>
        /// Propieadad a heredar donde se accede a la imagen
        ...
        /// Constructor de la clase
        /// </summary>
        public VisionProGrafico(object grafico)
            : base(grafico)
        {
        ...
        public VisionProGrafico(OrbitaImage graficoALiberar)
        ...
        public override object Clone()
        {
            VisionProGrafico graficoResultado = new VisionProGrafico();
        ...
        public override bool Guardar(string ruta)
        {
            try
            {
                if (base.Guardar(ruta))
                {
                    ...
                    {
                        LogsRuntime.Error(ModulosHardware.ImagenGraficosVPro, "VisionProGrafico", exception);
                    }
                    stream.Close();
    ...
    /// </summary>
    [Serializable]
    internal class VisionProImageExtras
    {
        #region Atributo(s)
        /// <summary>
        ...
        /// </summary>
        /// {
        public VisionProImageExtras(ICogTransform2D pixelFromRootTransform, CogCoordinateSpaceTree coordinateSpaceTree)
        {
