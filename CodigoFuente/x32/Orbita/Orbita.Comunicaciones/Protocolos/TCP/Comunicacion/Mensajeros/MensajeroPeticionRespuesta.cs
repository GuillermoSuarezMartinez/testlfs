...
namespace Orbita.Comunicaciones.Protocolos.Tcp.Comunicacion.Mensajeros
{
    ...
    public class MensajeroPeticionRespuesta<T> : IMensajero, IDisposable where T : IMensajero
    {
        ...
        /// </summary>
        private readonly ProcesadorElementosSecuenciales<IMensaje> _mensajesEntrantes;
        /// <summary>
        ...
        public MensajeroPeticionRespuesta(T mensajero)
        {
            Mensajero = mensajero;
            mensajero.MensajeRecibido += Mensajero_MensajeRecibido;
            mensajero.MensajeEnviado += Mensajero_MensajeEnviado;
            _mensajesEntrantes = new ProcesadorElementosSecuenciales<IMensaje>(OnMensajeRecibido);
        ...
        private void Mensajero_MensajeRecibido(object sender, MensajeEventArgs e)
        {
            ...
            _mensajesEntrantes.EncolarMensaje(e.Mensaje);
        }
        /// <summary>
        /// Manejador del evento MensajeRecibido del objeto mensajero.
        /// </summary>
