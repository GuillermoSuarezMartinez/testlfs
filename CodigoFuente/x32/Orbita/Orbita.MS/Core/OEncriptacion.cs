...
namespace Orbita.MS
{
    ...
    public class OEncriptacion
    {
        ...
        /// </param>
        public OEncriptacion(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize, string hashAlgorithm, string saltValue, int passwordIterations)
        {
        ...
        /// </returns>
        byte[] AddSalt(byte[] plainTextBytes)
        {
