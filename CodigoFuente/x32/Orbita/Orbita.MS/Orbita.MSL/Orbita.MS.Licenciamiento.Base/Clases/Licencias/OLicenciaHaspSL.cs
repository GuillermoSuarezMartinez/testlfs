...
{
    public class OLicenciaHaspSL : OLicenciaHaspBase
    {
        #region Atributos
        protected Type _tipo = typeof(OLicenciaHaspSL);
        #endregion Atributos
        #region Propiedades
        #endregion Propiedades
        #region Constructores
        public OLicenciaHaspSL()
            : base()
        {
            this.TipoLicencia = OTipoLicencia.Software;
