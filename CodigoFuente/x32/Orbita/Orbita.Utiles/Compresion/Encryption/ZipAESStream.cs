...
namespace Orbita.Utiles.Compresion.Encryption
{
            ...
            while (nBytes < count)
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < AUTH_CODE_LENGTH; i++)
                    {
                        ...
                        {
                            throw new Exception("AES Authentication Code does not match. This is a super-CRC check on the data in the file after compression and encryption." + Environment.NewLine
