	...
	public class DeflaterOutputStream : Stream
	{
		...
		public virtual void Finish()
		{
			...
			if (!deflater_.IsFinished) {
				throw new OCompresionFicherosExcepcionBase("Can't deflate all input?");
			}
		...
		protected void Deflate()
		{
			...
			if (!deflater_.IsNeedingInput) {
				throw new OCompresionFicherosExcepcionBase("DeflaterOutputStream can't deflate all input?");
			}
		}
		#endregion
