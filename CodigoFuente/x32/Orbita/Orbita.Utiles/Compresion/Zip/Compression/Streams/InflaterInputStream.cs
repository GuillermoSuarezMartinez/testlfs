...
namespace Orbita.Utiles.Compresion.Zip.Compression.Streams
{
    ...
    /// as the <see cref="Orbita.Utiles.Compresion.GZip.GZipInputStream">GZipInputStream</see>.
    ///
    ...
    public class InflaterInputStream : Stream
    {
        ...
        protected void Fill()
        {
            ...
            if (inputBuffer.Available <= 0)
            {
                ...
                if (inputBuffer.Available <= 0)
                {
                    throw new OCompresionFicherosExcepcionBase("Unexpected EOF");
                }
            }
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            {
                throw new OCompresionFicherosExcepcionBase("Need a dictionary");
            }
