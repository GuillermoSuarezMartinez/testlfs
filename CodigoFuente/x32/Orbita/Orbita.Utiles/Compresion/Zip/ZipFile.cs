...
using Orbita.Utiles.Compresion.Encryption;
#endif
...
using Orbita.Utiles.Compresion.Zip.Compression;
...
namespace Orbita.Utiles.Compresion.Zip
{
    ...
    public class ZipFile : IEnumerable, IDisposable
    {
        ...
        public int FindEntry(string name, bool ignoreCase)
        {
            ...
            {
                if (string.Compare(name, entries_[i].Name, ignoreCase, CultureInfo.CurrentCulture) == 0)
                {
                    return i;
                }
            }
        ...
        /// </exception>
        /// <exception cref="Orbita.Utiles.Compresion.Zip.ZipException">
...
*/
            ...
            /*
                        ...
                        for (int index = 0; index < updates_.Count; ++index)
                        {
                            ...
                            if ( (zu.Entry.ZipFileIndex == entry.ZipFileIndex) &&
                                (string.Compare(convertedName, zu.Entry.Name, true, CultureInfo.CurrentCulture) == 0) ) {
                                result = index;
                                break;
                            }
                        }
        ...
        Stream CreateAndInitDecryptionStream(Stream baseStream, ZipEntry entry)
        {
                ...
                || (entry.Flags & (int)GeneralBitFlags.StrongEncryption) == 0)
            {
                ...
                if (HaveKeys == false)
                {
                    throw new OCompresionFicherosExcepcionContraseñaNoProporcionada();
        ...
        static void CheckClassicPassword(CryptoStream classicCryptoStream, ZipEntry entry)
        {
            ...
            if (cryptbuffer[ZipConstants.CryptoHeaderSize - 1] != entry.CryptoCheckValue)
            {
                ...
                throw new OCompresionFicherosExcepcionContraseñaInválida();
            }
        }
#endif
