...
Namespace Orbita.Winsock
    ...
    Public Class AsyncSocket
        Private myParent As IWinsock                    'The parent WinsockBase - allows access to properties and event raising
...
#Region " Public Methods "
        ...
        Public Sub Connect(ByVal remoteHostOrIp As String, ByVal remote_port As Integer)
            Try
                If myParent.State <> WinsockStates.Closed Then
                    Throw New Exception("No es posible conectar con el host remoto cuando el estado del socket no es cerrado.")
                End If
...
#Region " Callback Methods "
        ...
        Private Sub ListenCallback(ByVal ar As IAsyncResult)
            Try
                ...
                ' If the WinsockBase is no longer in the listening state
        ...
        Private Sub SendCallback(ByVal ar As IAsyncResult)
            Try
                ...
                Dim e As New WinsockSendEventArgs(RemoteIP, ssState.TotalSent, ssState.Length, ssState.Data)
...
#Region " Private Methods "
        ...
        Private Sub DoSend()
            Try
                ...
                If myParent.Protocol = WinsockProtocol.Tcp Then
                    Dim ssState As SendState = SendState.Build(fullSize, mSock1, incBufferSize, byt)
...
#Region " Private Classes "
        ...
        Private Class SendState
            ...
            ''' <summary>
            ''' Array que contiene el mensaje de envio.
            ''' </summary>
            ''' <remarks></remarks>
            Public Data As Byte()
            ...
            Public Shared Function Build(ByVal bytUpperBound As Integer, ByRef sock As Socket, ByVal buffer_size As Integer, ByVal msg As Byte()) As SendState
