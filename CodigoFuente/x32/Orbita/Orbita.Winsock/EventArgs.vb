Namespace Orbita.Winsock
    ...
    ''' <summary>
    ''' Provides data for the WinsockBase.ErrorReceived event.
    ''' </summary>
    ...
    ''' <summary>
    ''' Provides data for the WinsockBase.ConnectionRequest event.
    ''' </summary>
    ...
    ''' <summary>
    ''' Provides data for the WinsockBase.StateChanged event.
    ''' </summary>
    Public Class WinsockStateChangedEventArgs
        ...
        ''' </summary>
        ''' <param name="oldState">The old state of the WinsockBase control.</param>
        ''' <param name="newState">The state the WinsockBase control is changing to.</param>
        ...
        ''' <summary>
        ''' Gets a value indicating the previous state of the WinsockBase control.
        ''' </summary>
        ...
        ''' <summary>
        ''' Gets a value indicating the new state of the WinsockBase control.
        ''' </summary>
    ...
    ''' <summary>
    ''' Provides data for the WinsockBase.DataArrival event.
    ''' </summary>
    ...
    ''' <summary>
    ''' Provides data for the WinsockBase.Connected event.
    ''' </summary>
    ...
    ''' <summary>
    ''' Provides data for the WinsockBase.SendComplete event.
    ''' </summary>
    Public Class WinsockSendEventArgs
        ...
        ''' <param name="bytes_sent">The total number of bytes sent.</param>
        ''' <param name="bytes_total">The total number of bytes that were supposed to be sent.</param>
        ''' <param name="data_sent">The total data of bytes that were supposed to be sent.</param>
        Public Sub New(ByVal dest_ip As String, ByVal bytes_sent As Integer, ByVal bytes_total As Integer, ByVal data_sent As Byte())
            _IP = dest_ip
            _bTotal = bytes_total
            _bSent = bytes_sent
            _dSent = data_sent
        ...
        ''' <summary>
        ''' Gets a value indicating the data to sent.
        ''' </summary>
        Public ReadOnly Property DataSent() As Byte()
            Get
                Return _dSent
            End Get
        End Property
    ...
    ''' <summary>
    ''' Provides data for the WinsockBase.ReceiveProgress event.
    ''' </summary>
