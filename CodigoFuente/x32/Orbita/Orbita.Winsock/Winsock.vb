...
#Region " Helper Methods "
        ...
        ''' </summary>
        ''' <param name="new_state">The new state of the WinsockBase.</param>
...
#Region " Public Properties "
        ...
        ''' <summary>
        ''' Gets a NetworkStream that this WinsockBase object is based on.
        ''' </summary>
        <Browsable(False)> _
...
#Region " Public Methods "
        ...
        ''' </remarks>
        Public Function AcceptNew(ByVal client As Sockets.Socket) As OWinsockBase
            Dim wskReturn As New OWinsockBase()
